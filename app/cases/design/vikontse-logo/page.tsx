...
const finalItems = [
  { src: "/media/cases/vikontse-logo/vikontse-logo1.webp", w: 1000, h: 1000, titleKey: "designCases.vikontseLogo.item1.title", captionKey: "designCases.vikontseLogo.item1.caption" },
];

const results = [
  "designCases.vikontseLogo.result1",
  "designCases.vikontseLogo.result2",
  "designCases.vikontseLogo.result3",
];
...
export default function VikontseLogoPage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.vikontseLogo.backToList")}
        </Link>
      </div>
      ...
      <section ref={heroRef} className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(249, 115, 22, 0.12)",
                "--case-glow-strong": "rgba(249, 115, 22, 0.28)",
          ...
          >
            ...
            >
              <motion.div
                ...
                className="relative rounded-xl bg-white max-w-[680px] mx-auto overflow-visible flex items-center justify-center"
                style={{ boxShadow: "0 30px 80px rgba(0, 0, 0, 0.6), 0 10px 30px rgba(0, 0, 0, 0.4)" }}
              >
                <Image
                  src="/media/cases/vikontse-logo/vikontse-logo1.webp"
                  alt={t("designCases.vikontseLogo.title")}
                  width={1000}
                  height={1000}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.vikontseLogo.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.vikontseLogo.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.vikontseLogo.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.vikontseLogo.finalsIntro")}
            </p>
          </FadeIn>
            ...
            {finalItems.map((item, i) => (
              <FadeIn key={item.src} delay={0.1 + i * 0.1} y={30} blur={4}>
                <div className="featured-case-card border border-border rounded-2xl p-4" style={{ borderRadius: "16px" }}>
                  <div className="relative rounded-xl border border-border bg-white overflow-visible flex items-center justify-center">
                    <Image
                      src={item.src}
                      alt={t(item.titleKey)}
                      width={item.w}
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(249, 115, 22, 0.12)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.vikontseLogo.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#F97316] mx-auto mb-6 opacity-50" />
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.vikontseLogo.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.vikontseLogo.reviewAuthor")} />
                <p className="text-[#F97316] font-semibold">{t("designCases.vikontseLogo.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="vikontse-logo" section="design" />
    </article>
  );
}
