...
const finalItems = [
  { src: "/media/cases/f5-guitars-youtube/f5-guitars-youtube1.webp", w: 1280, h: 720, titleKey: "designCases.f5Guitars.item1.title", captionKey: "designCases.f5Guitars.item1.caption" },
];

const results = [
  "designCases.f5Guitars.result1",
  "designCases.f5Guitars.result2",
  "designCases.f5Guitars.result3",
];
...
export default function F5GuitarsPage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.f5Guitars.backToList")}
        </Link>
      </div>
      ...
      <section ref={heroRef} className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(239, 68, 68, 0.10)",
                "--case-glow-strong": "rgba(34, 197, 94, 0.26)",
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/f5-guitars-youtube/f5-guitars-youtube1.webp"
                  alt={t("designCases.f5Guitars.title")}
                  width={1280}
                  height={720}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.f5Guitars.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.f5Guitars.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.f5Guitars.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.f5Guitars.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(239, 68, 68, 0.10)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.f5Guitars.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-red-500 mx-auto mb-6 opacity-50" />
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.f5Guitars.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.f5Guitars.reviewAuthor")} />
                <p className="text-red-500 font-semibold">{t("designCases.f5Guitars.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="f5-guitars-youtube" section="design" />
    </article>
  );
}
