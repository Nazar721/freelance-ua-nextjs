...
const finalItems = [
  { src: "/media/cases/nastya-smm/nastya-smm1.webp", w: 1750, h: 2187, titleKey: "designCases.nastyaSmm.item1.title", captionKey: "designCases.nastyaSmm.item1.caption" },
  { src: "/media/cases/nastya-smm/nastya-smm2.webp", w: 1700, h: 2241, titleKey: "designCases.nastyaSmm.item2.title", captionKey: "designCases.nastyaSmm.item2.caption" },
];

const results = [
  "designCases.nastyaSmm.result1",
  "designCases.nastyaSmm.result2",
  "designCases.nastyaSmm.result3",
];
...
export default function NastyaSmmPage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.nastyaSmm.backToList")}
        </Link>
      </div>
      ...
      <section ref={heroRef} className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(251, 191, 36, 0.12)",
                "--case-glow-strong": "rgba(251, 191, 36, 0.28)",
              } as React.CSSProperties
            }
          >
            {/* Mobile: vertical stack */}
            <motion.div
              className="md:hidden px-4 py-8 space-y-6"
              style={{
                scale: mockupScale,
                y: mockupY,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.nastyaSmm.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.nastyaSmm.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.nastyaSmm.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.nastyaSmm.finalsIntro")}
            </p>
          </FadeIn>
            ...
            {finalItems.map((item, i) => (
              <FadeIn key={item.src} delay={0.1 + i * 0.1} y={30} blur={4}>
                <div className="featured-case-card border border-border rounded-2xl p-4" style={{ borderRadius: "16px" }}>
                  <div className="relative overflow-hidden rounded-xl border border-border bg-background max-w-md mx-auto">
                    <Image
                      src={item.src}
                      alt={t(item.titleKey)}
                      width={item.w}
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(251, 191, 36, 0.12)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-lg mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.nastyaSmm.reviewTitle")}
            </h2>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="nastya-smm" section="design" />
    </article>
  );
}
