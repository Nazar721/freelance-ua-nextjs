...
const finalItems = [
  { src: "/media/cases/sembud-repair/sembud-repair1.webp", w: 1080, h: 1080, titleKey: "designCases.sembudRepair.item1.title", captionKey: "designCases.sembudRepair.item1.caption" },
];

const results = [
  "designCases.sembudRepair.result1",
  "designCases.sembudRepair.result2",
  "designCases.sembudRepair.result3",
  "designCases.sembudRepair.result4",
];
...
export default function SembudRepairPage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.sembudRepair.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            style={
              {
                ...
                "--case-glow-strong": "rgba(239, 68, 68, 0.28)",
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/sembud-repair/sembud-repair1.webp"
                  alt={t("designCases.sembudRepair.title")}
                  width={1080}
                  height={1080}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.sembudRepair.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.sembudRepair.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.sembudRepair.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.sembudRepair.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.sembudRepair.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              ...
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.sembudRepair.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.sembudRepair.reviewAuthor")} />
                <p className="text-red-500 font-semibold">{t("designCases.sembudRepair.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="sembud-repair" section="design" />
    </article>
  );
}
