...
const approachItems = [
  "designCases.colorCorrection.approach1",
  "designCases.colorCorrection.approach2",
  "designCases.colorCorrection.approach3",
  "designCases.colorCorrection.approach4",
];

const resultItems = [
  "designCases.colorCorrection.result1",
  "designCases.colorCorrection.result2",
  "designCases.colorCorrection.result3",
];
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.colorCorrection.backToList")}
        </Link>
      </div>
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("designCases.colorCorrection.category")}
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("designCases.colorCorrection.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("designCases.colorCorrection.subtitle")}
            </p>
          </FadeIn>
            ...
            style={
              {
                ...
                "--case-glow-strong": "rgba(168, 132, 100, 0.25)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.colorCorrection.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.colorCorrection.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
              {t("designCases.colorCorrection.approachTitle")}
            </h2>
          </FadeIn>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {approachItems.map((item, i) => (
              <FadeIn key={i} delay={0.05 + i * 0.08} y={20} blur={4}>
                <div className="flex items-start gap-3 p-4 rounded-xl bg-surface-elevated/40 border border-border">
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(168, 132, 100, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.colorCorrection.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background p-4">
                <Image
                  src="/media/cases/color-correction/screenshot.png"
                  alt="Відгук — підхід до обробки"
                  width={1200}
                  height={630}
                  unoptimized
                  className="w-full h-auto object-cover rounded-xl max-w-[600px]"
                />
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("designCases.colorCorrection.teamMember")}
          </p>
        </div>
      </section>
      ...
      <RelatedProjectsSection currentSlug="color-correction" section="design" />
