...
const finalItems = [
  { src: "/media/cases/apple-tecnologia/apple-tecnologia1.webp", w: 1080, h: 1080, titleKey: "designCases.appleTecnologia.item1.title", captionKey: "designCases.appleTecnologia.item1.caption" },
];

const results = [
  "designCases.appleTecnologia.result1",
  "designCases.appleTecnologia.result2",
  "designCases.appleTecnologia.result3",
];
...
export default function AppleTecnologiaPage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.appleTecnologia.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground mb-4 block">
              {t("designCases.appleTecnologia.category")}
            </span>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("designCases.appleTecnologia.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("designCases.appleTecnologia.subtitle")}
            </p>
          </FadeIn>
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(163, 230, 53, 0.12)",
                "--case-glow-strong": "rgba(163, 230, 53, 0.28)",
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/apple-tecnologia/apple-tecnologia1.webp"
                  alt={t("designCases.appleTecnologia.title")}
                  width={1080}
                  height={1080}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.appleTecnologia.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.appleTecnologia.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.appleTecnologia.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.appleTecnologia.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(163, 230, 53, 0.12)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.appleTecnologia.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#A3E635] mx-auto mb-6 opacity-50" />
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.appleTecnologia.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.appleTecnologia.reviewAuthor")} />
                <p className="text-[#A3E635] font-semibold">{t("designCases.appleTecnologia.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="apple-tecnologia" section="design" />
    </article>
  );
}
