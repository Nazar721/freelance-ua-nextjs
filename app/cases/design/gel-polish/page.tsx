...
const finalItems = [
  { src: "/media/cases/gel-polish/gel-polish1.webp", w: 900, h: 1200, titleKey: "designCases.gelPolish.item1.title", captionKey: "designCases.gelPolish.item1.caption" },
];

const results = [
  "designCases.gelPolish.result1",
  "designCases.gelPolish.result2",
  "designCases.gelPolish.result3",
];
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.gelPolish.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/gel-polish/gel-polish1.webp"
                  alt={t("designCases.gelPolish.title")}
                  width={900}
                  height={1200}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.gelPolish.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.gelPolish.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.gelPolish.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.gelPolish.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.gelPolish.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              ...
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.gelPolish.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.gelPolish.reviewAuthor")} />
                <p className="text-red-500 font-semibold">{t("designCases.gelPolish.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="gel-polish" section="design" />
    </article>
  );
}
