...
const finalItems = [
  { src: "/media/cases/smm-case-presentation/smm-case-presentation1.webp", w: 1280, h: 749, titleKey: "designCases.smmCasePresentation.item1.title", captionKey: "designCases.smmCasePresentation.item1.caption", wide: false },
...
const results = [
  ...
  "designCases.smmCasePresentation.result2",
  "designCases.smmCasePresentation.result3",
];
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.smmCasePresentation.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground mb-4 block">
              {t("designCases.smmCasePresentation.category")}
            </span>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("designCases.smmCasePresentation.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("designCases.smmCasePresentation.subtitle")}
            </p>
          </FadeIn>
            ...
            style={
              {
                ...
                "--case-glow-strong": "rgba(99, 102, 241, 0.28)",
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/smm-case-presentation/smm-case-presentation1.webp"
                  alt={t("designCases.smmCasePresentation.title")}
                  width={1280}
                  height={749}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.smmCasePresentation.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.smmCasePresentation.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.smmCasePresentation.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.smmCasePresentation.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(99, 102, 241, 0.12)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.smmCasePresentation.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              ...
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.smmCasePresentation.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.smmCasePresentation.reviewAuthor")} />
                <p className="text-primary font-semibold">{t("designCases.smmCasePresentation.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
