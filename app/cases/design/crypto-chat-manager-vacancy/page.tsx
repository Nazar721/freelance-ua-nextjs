...
const finalItems = [
  { src: "/media/cases/crypto-chat-manager-vacancy/crypto-chat-manager-vacancy1.webp", w: 720, h: 1280, titleKey: "designCases.cryptoChatManagerVacancy.item1.title", captionKey: "designCases.cryptoChatManagerVacancy.item1.caption" },
];

const results = [
  "designCases.cryptoChatManagerVacancy.result1",
  "designCases.cryptoChatManagerVacancy.result2",
  "designCases.cryptoChatManagerVacancy.result3",
];
...
export default function CryptoChatManagerVacancyPage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.cryptoChatManagerVacancy.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground mb-4 block">
              {t("designCases.cryptoChatManagerVacancy.category")}
            </span>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("designCases.cryptoChatManagerVacancy.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("designCases.cryptoChatManagerVacancy.subtitle")}
            </p>
          </FadeIn>
            ...
            style={
              {
                ...
                "--case-glow-strong": "rgba(132, 204, 22, 0.28)",
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/crypto-chat-manager-vacancy/crypto-chat-manager-vacancy1.webp"
                  alt={t("designCases.cryptoChatManagerVacancy.title")}
                  width={720}
                  height={1280}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.cryptoChatManagerVacancy.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.cryptoChatManagerVacancy.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.cryptoChatManagerVacancy.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.cryptoChatManagerVacancy.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.cryptoChatManagerVacancy.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#84CC16] mx-auto mb-6 opacity-50" />
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.cryptoChatManagerVacancy.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.cryptoChatManagerVacancy.reviewAuthor")} />
                <p className="text-[#84CC16] font-semibold">{t("designCases.cryptoChatManagerVacancy.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="crypto-chat-manager-vacancy" section="design" />
    </article>
  );
}
