...
const finalItems = [
  { src: "/media/cases/gopro-hero13/gopro-hero131.webp", w: 900, h: 1200, titleKey: "designCases.goproHero13.item1.title", captionKey: "designCases.goproHero13.item1.caption" },
];

const results = [
  "designCases.goproHero13.result1",
  "designCases.goproHero13.result2",
  "designCases.goproHero13.result3",
];
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.goproHero13.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
            ...
            style={
              {
                ...
                "--case-glow-strong": "rgba(59, 130, 246, 0.28)",
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/gopro-hero13/gopro-hero131.webp"
                  alt={t("designCases.goproHero13.title")}
                  width={900}
                  height={1200}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.goproHero13.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.goproHero13.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.goproHero13.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.goproHero13.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.goproHero13.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#3B82F6] mx-auto mb-6 opacity-50" />
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.goproHero13.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.goproHero13.reviewAuthor")} />
                <p className="text-[#3B82F6] font-semibold">{t("designCases.goproHero13.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="gopro-hero13" section="design" />
    </article>
  );
}
