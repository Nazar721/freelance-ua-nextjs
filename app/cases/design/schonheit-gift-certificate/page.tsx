...
const finalItems = [
  { src: "/media/cases/schonheit-gift-certificate/schonheit-gift-certificate1.webp", w: 874, h: 620, titleKey: "designCases.schonheitGiftCertificate.item1.title", captionKey: "designCases.schonheitGiftCertificate.item1.caption" },
];

const results = [
  "designCases.schonheitGiftCertificate.result1",
  "designCases.schonheitGiftCertificate.result2",
  "designCases.schonheitGiftCertificate.result3",
];
...
export default function SchonheitGiftCertificatePage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.schonheitGiftCertificate.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground mb-4 block">
              {t("designCases.schonheitGiftCertificate.category")}
            </span>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("designCases.schonheitGiftCertificate.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("designCases.schonheitGiftCertificate.subtitle")}
            </p>
          </FadeIn>
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(245, 208, 154, 0.12)",
                "--case-glow-strong": "rgba(245, 208, 154, 0.3)",
          ...
          >
            ...
            >
              <motion.div
                ...
                className="relative overflow-hidden rounded-xl bg-black max-w-3xl mx-auto"
                style={{ boxShadow: "0 30px 80px rgba(0, 0, 0, 0.6), 0 10px 30px rgba(0, 0, 0, 0.4)" }}
              >
                <Image
                  src="/media/cases/schonheit-gift-certificate/schonheit-gift-certificate1.webp"
                  alt={t("designCases.schonheitGiftCertificate.title")}
                  width={874}
                  height={620}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.schonheitGiftCertificate.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.schonheitGiftCertificate.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.schonheitGiftCertificate.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.schonheitGiftCertificate.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(245, 208, 154, 0.12)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.schonheitGiftCertificate.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#F5D09A] mx-auto mb-6 opacity-50" />
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.schonheitGiftCertificate.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.schonheitGiftCertificate.reviewAuthor")} />
                <p className="text-[#F5D09A] font-semibold">{t("designCases.schonheitGiftCertificate.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="schonheit-gift-certificate" section="design" />
    </article>
  );
}
