...
const finalItems = [
  { src: "/media/cases/prestige-school-billboard/prestige-billboard1.webp", w: 1280, h: 640, titleKey: "designCases.prestigeSchoolBillboard.item1.title", captionKey: "designCases.prestigeSchoolBillboard.item1.caption" },
];

const results = [
  "designCases.prestigeSchoolBillboard.result1",
  "designCases.prestigeSchoolBillboard.result2",
  "designCases.prestigeSchoolBillboard.result3",
];
...
export default function PrestigeSchoolBillboardPage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.prestigeSchoolBillboard.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground mb-4 block">
              {t("designCases.prestigeSchoolBillboard.category")}
            </span>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("designCases.prestigeSchoolBillboard.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("designCases.prestigeSchoolBillboard.subtitle")}
            </p>
          </FadeIn>
            ...
            style={
              {
                ...
                "--case-glow-strong": "rgba(139, 92, 246, 0.28)",
          ...
          >
            ...
            >
              <motion.div
                ...
                className="relative overflow-hidden rounded-xl bg-black max-w-4xl mx-auto"
                style={{ boxShadow: "0 30px 80px rgba(0, 0, 0, 0.6), 0 10px 30px rgba(0, 0, 0, 0.4)" }}
              >
                <Image
                  src="/media/cases/prestige-school-billboard/prestige-billboard1.webp"
                  alt={t("designCases.prestigeSchoolBillboard.title")}
                  width={1280}
                  height={640}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.prestigeSchoolBillboard.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.prestigeSchoolBillboard.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.prestigeSchoolBillboard.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.prestigeSchoolBillboard.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.prestigeSchoolBillboard.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-purple-400 mx-auto mb-6 opacity-50" />
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.prestigeSchoolBillboard.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.prestigeSchoolBillboard.reviewAuthor")} />
                <p className="text-purple-400 font-semibold">{t("designCases.prestigeSchoolBillboard.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="prestige-school-billboard" section="design" />
    </article>
  );
}
