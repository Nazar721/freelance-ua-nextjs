...
const finalItems = [
  { src: "/media/cases/mydutyfree/mydutyfree1.webp", w: 904, h: 1280, titleKey: "designCases.mydutyfree.item1.title", captionKey: "designCases.mydutyfree.item1.caption" },
];

const results = [
  "designCases.mydutyfree.result1",
  "designCases.mydutyfree.result2",
  "designCases.mydutyfree.result3",
  "designCases.mydutyfree.result4",
];
...
export default function MyDutyFreePage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.mydutyfree.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/mydutyfree/mydutyfree1.webp"
                  alt={t("designCases.mydutyfree.title")}
                  width={904}
                  height={1280}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.mydutyfree.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.mydutyfree.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.mydutyfree.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.mydutyfree.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(236, 72, 153, 0.12)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.mydutyfree.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              ...
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.mydutyfree.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.mydutyfree.reviewAuthor")} />
                <p className="text-[#EC4899] font-semibold">{t("designCases.mydutyfree.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="mydutyfree" section="design" />
    </article>
  );
}
