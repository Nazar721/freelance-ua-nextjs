...
const finalItems = [
  { src: "/media/cases/divorce-legal-ad/divorce-legal-ad1.webp", w: 1024, h: 1280, titleKey: "designCases.divorceLegalAd.item1.title", captionKey: "designCases.divorceLegalAd.item1.caption" },
];

const results = [
  "designCases.divorceLegalAd.result1",
  "designCases.divorceLegalAd.result2",
  "designCases.divorceLegalAd.result3",
  "designCases.divorceLegalAd.result4",
];
...
export default function DivorceLegalAdPage() {
  ...
  return (
    <article className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        >
          <ArrowLeft size={16} />
          {t("designCases.divorceLegalAd.backToList")}
        </Link>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground mb-4 block">
              {t("designCases.divorceLegalAd.category")}
            </span>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("designCases.divorceLegalAd.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("designCases.divorceLegalAd.subtitle")}
            </p>
          </FadeIn>
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(136, 19, 55, 0.14)",
                "--case-glow-strong": "rgba(136, 19, 55, 0.3)",
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/media/cases/divorce-legal-ad/divorce-legal-ad1.webp"
                  alt={t("designCases.divorceLegalAd.title")}
                  width={1024}
                  height={1280}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.divorceLegalAd.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("designCases.divorceLegalAd.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
              {t("designCases.divorceLegalAd.finalsTitle")}
            </h2>
            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
              {t("designCases.divorceLegalAd.finalsIntro")}
            </p>
          </FadeIn>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(136, 19, 55, 0.14)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("designCases.divorceLegalAd.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 md:p-12 text-center" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#881337] mx-auto mb-6 opacity-50" />
              <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                &ldquo;{t("designCases.divorceLegalAd.reviewText")}&rdquo;
              </p>
              <div className="flex items-center justify-center gap-3">
                <ReviewAvatar name={t("designCases.divorceLegalAd.reviewAuthor")} />
                <p className="text-[#881337] font-semibold">{t("designCases.divorceLegalAd.reviewAuthor")}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <RelatedProjectsSection currentSlug="divorce-legal-ad" section="design" />
    </article>
  );
}
