...
const components = [
  {
    titleKey: "itCases.routeCore.component1Title",
    descKey: "itCases.routeCore.component1Desc",
    images: ["/media/cases/routecore1.jpeg"],
    link: "https://route-core-umber.vercel.app/",
    linkLabelKey: "itCases.routeCore.viewSiteLabel",
  },
  {
    titleKey: "itCases.routeCore.component2Title",
    descKey: "itCases.routeCore.component2Desc",
    images: ["/media/cases/routecore2.jpeg"],
  },
  {
    titleKey: "itCases.routeCore.component3Title",
    descKey: "itCases.routeCore.component3Desc",
    images: ["/media/cases/routecore3.jpeg"],
  },
  {
    titleKey: "itCases.routeCore.component4Title",
    descKey: "itCases.routeCore.component4Desc",
    images: ["/media/cases/routecore4.jpeg"],
  },
];

const results = [
  "itCases.routeCore.result1",
  "itCases.routeCore.result2",
  "itCases.routeCore.result3",
  "itCases.routeCore.result4",
  "itCases.routeCore.result5",
  "itCases.routeCore.result6",
  "itCases.routeCore.result7",
  "itCases.routeCore.result8",
];
...
export default function RouteCorePage() {
    ...
    <article className="min-h-screen">
      ...
      <section ref={heroRef} className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <Image
                src="/media/cases/routecore-mocap.webp"
                alt={t("itCases.routeCore.title")}
                width={1200}
                height={800}
          ...
          <div className="flex mt-8">
            <a
              href="https://route-core-umber.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-purple-500 transition-colors duration-300"
            >
              {t("itCases.routeCore.viewSiteLabel")}
              <ArrowRight size={16} />
            </a>
          </div>
        </div>
                ...
                <div className={`featured-case-card p-6 md:p-8 ${"link" in comp && comp.link ? "pb-10 md:pb-12" : ""}`} style={{ borderRadius: "16px" }}>
                  ...
                  {"link" in comp && comp.link && "linkLabelKey" in comp && comp.linkLabelKey && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-6 text-sm font-semibold text-primary hover:text-purple-500 transition-colors duration-300"
                    >
                      {t(comp.linkLabelKey)}
                      <ArrowRight size={16} />
                    </a>
      ...
      <section className="py-16 px-4">
        <div className="max-w-lg mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("itCases.routeCore.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 relative" style={{ borderRadius: "20px" }}>
              ...
              <p className="text-foreground text-base leading-relaxed mb-6 whitespace-pre-line">
                {t("itCases.routeCore.reviewText")}
              </p>
              <div className="flex items-center gap-3">
                <ReviewAvatar name={t("itCases.routeCore.reviewAuthor")} size={32} />
                <p className="text-muted-foreground text-sm font-medium">
                  {t("itCases.routeCore.reviewAuthor")}
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="route-core" />
