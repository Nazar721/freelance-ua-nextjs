...
const components = [
  {
    titleKey: "itCases.pivdenSolar.component1Title",
    descKey: "itCases.pivdenSolar.component1Desc",
    images: ["/media/cases/pivdensolar1.jpeg"],
    link: "https://pivdensolar.com.ua/",
    linkLabelKey: "itCases.pivdenSolar.viewSiteLabel",
  },
  {
    titleKey: "itCases.pivdenSolar.component2Title",
    descKey: "itCases.pivdenSolar.component2Desc",
    images: ["/media/cases/pivdensolar2.webp"],
  },
  {
    titleKey: "itCases.pivdenSolar.component3Title",
    descKey: "itCases.pivdenSolar.component3Desc",
    images: ["/media/cases/pivdensolar3.jpeg"],
  },
  {
    titleKey: "itCases.pivdenSolar.component4Title",
    descKey: "itCases.pivdenSolar.component4Desc",
    images: ["/media/cases/pivdensolar4.webp"],
  },
];

const results = [
  "itCases.pivdenSolar.result1",
  "itCases.pivdenSolar.result2",
  "itCases.pivdenSolar.result3",
  "itCases.pivdenSolar.result4",
  "itCases.pivdenSolar.result5",
  "itCases.pivdenSolar.result6",
  "itCases.pivdenSolar.result7",
  "itCases.pivdenSolar.result8",
];
...
export default function PivdenSolarPage() {
    ...
    <article className="min-h-screen">
      ...
      <section ref={heroRef} className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(34, 197, 94, 0.15)",
                "--case-glow-strong": "rgba(34, 197, 94, 0.3)",
          ...
          >
            <div className="overflow-hidden rounded-2xl">
              ...
              >
                <Image
                  src="/media/cases/pivdensolar-mocap-v2.webp"
                  alt={t("itCases.pivdenSolar.title")}
                  width={1200}
                  height={800}
          ...
          <div className="flex mt-8">
            <a
              href="https://pivdensolar.com.ua/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm font-semibold text-green-500 hover:text-[#16A34A] transition-colors duration-300"
            >
              {t("itCases.pivdenSolar.viewSiteLabel")}
              <ArrowRight size={16} />
            </a>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("itCases.pivdenSolar.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("itCases.pivdenSolar.solution")}
              </p>
            </motion.div>
          </div>
        </div>
                ...
                <div className={`featured-case-card p-6 md:p-8 ${"link" in comp && comp.link ? "pb-10 md:pb-12" : ""}`} style={{ borderRadius: "16px" }}>
                  ...
                  {"link" in comp && comp.link && "linkLabelKey" in comp && comp.linkLabelKey && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-6 text-sm font-semibold text-green-500 hover:text-[#16A34A] transition-colors duration-300"
                    >
                      {t(comp.linkLabelKey)}
                      <ArrowRight size={16} />
                    </a>
      ...
      <section className="py-16 px-4">
        <div className="max-w-lg mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("itCases.pivdenSolar.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 relative" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-green-500/40 mb-4" />
              <p className="text-foreground text-base leading-relaxed mb-6">
                {t("itCases.pivdenSolar.reviewText")}
              </p>
              <div className="flex items-center gap-3">
                <ReviewAvatar name={t("itCases.pivdenSolar.reviewAuthor")} size={32} />
                <p className="text-muted-foreground text-sm font-medium">
                  {t("itCases.pivdenSolar.reviewAuthor")}
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="pivden-solar" />
