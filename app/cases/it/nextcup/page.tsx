...
const components = [
  {
    titleKey: "itCases.nextCup.component1Title",
    descKey: "itCases.nextCup.component1Desc",
    images: ["/media/cases/nextcup1.jpeg"],
    link: "https://nextcup.com.ua/",
    linkLabelKey: "itCases.nextCup.viewSiteLabel",
  },
  {
    titleKey: "itCases.nextCup.component2Title",
    descKey: "itCases.nextCup.component2Desc",
    images: ["/media/cases/nextcup2.webp"],
  },
  {
    titleKey: "itCases.nextCup.component3Title",
    descKey: "itCases.nextCup.component3Desc",
    images: ["/media/cases/nextcup3.webp"],
  },
  {
    titleKey: "itCases.nextCup.component4Title",
    descKey: "itCases.nextCup.component4Desc",
    images: ["/media/cases/nextcup4.webp"],
  },
];

const results = [
  "itCases.nextCup.result1",
  "itCases.nextCup.result2",
  "itCases.nextCup.result3",
  "itCases.nextCup.result4",
  "itCases.nextCup.result5",
  "itCases.nextCup.result6",
  "itCases.nextCup.result7",
  "itCases.nextCup.result8",
];
...
export default function NextCupPage() {
  ...
  return (
    <article className="min-h-screen">
      ...
      <section ref={heroRef} className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            ...
            style={
                {
                  "--case-glow": "rgba(94, 45, 77, 0.18)",
                  "--case-glow-strong": "rgba(94, 45, 77, 0.4)",
          ...
          >
            ...
            >
              <Image
                src="/media/cases/nextcup-mocap.webp"
                alt={t("itCases.nextCup.title")}
                width={1200}
                height={800}
          ...
          <div className="flex mt-8">
            <a
              href="https://nextcup.com.ua/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm font-semibold text-[#C98BAA] hover:text-[#E3ACCB] transition-colors duration-300"
            >
              {t("itCases.nextCup.viewSiteLabel")}
              <ArrowRight size={16} />
            </a>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(94, 45, 77, 0.18)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
                ...
                <div className={`featured-case-card p-6 md:p-8 ${"link" in comp && comp.link ? "pb-10 md:pb-12" : ""}`} style={{ borderRadius: "16px" }}>
                  ...
                  {"link" in comp && comp.link && "linkLabelKey" in comp && comp.linkLabelKey && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-6 text-sm font-semibold text-[#C98BAA] hover:text-[#E3ACCB] transition-colors duration-300"
                    >
                      {t(comp.linkLabelKey)}
                      <ArrowRight size={16} />
                    </a>
        ...
        <div className="max-w-lg mx-auto">
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 relative" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#C98BAA]/40 mb-4" />
              <p className="text-foreground text-base leading-relaxed mb-6 whitespace-pre-line">
                {t("itCases.nextCup.reviewText")}
              </p>
              <div className="flex items-center gap-3">
                <ReviewAvatar name={t("itCases.nextCup.reviewAuthor")} size={32} />
                <p className="text-muted-foreground text-sm font-medium">
                  {t("itCases.nextCup.reviewAuthor")}
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="nextcup" />
