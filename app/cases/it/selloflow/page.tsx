...
const components = [
  {
    titleKey: "itCases.selloflow.component1Title",
    descKey: "itCases.selloflow.component1Desc",
    image: "/media/cases/selloflow-dashboard.webp",
  },
  {
    titleKey: "itCases.selloflow.component2Title",
    descKey: "itCases.selloflow.component2Desc",
    image: "/media/cases/selloflow-products.webp",
  },
  {
    titleKey: "itCases.selloflow.component3Title",
    descKey: "itCases.selloflow.component3Desc",
    image: "/media/cases/selloflow-orders.webp",
  },
  {
    titleKey: "itCases.selloflow.component4Title",
    descKey: "itCases.selloflow.component4Desc",
    image: "/media/cases/selloflow-settings.webp",
  },
  {
    titleKey: "itCases.selloflow.component5Title",
    descKey: "itCases.selloflow.component5Desc",
    image: "/media/cases/selloflow-pricing.webp",
  },
];

const results = [
  "itCases.selloflow.result1",
  "itCases.selloflow.result2",
  "itCases.selloflow.result3",
  "itCases.selloflow.result4",
  "itCases.selloflow.result5",
  "itCases.selloflow.result6",
  "itCases.selloflow.result7",
  "itCases.selloflow.result8",
  "itCases.selloflow.result9",
];
...
export default function SelloflowPage() {
  const { t } = useTranslation();
  const heroRef = useRef<HTMLDivElement>(null);
  const allImages = components.filter((c) => c.image).map((c) => c.image!);
    ...
    <article className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="overflow-hidden rounded-2xl">
              ...
              >
                <Image
                  src="/media/cases/selloflow-mocap.webp?v=2"
                  alt={t("itCases.selloflow.title")}
                  width={1672}
                  height={941}
          ...
          <div className="flex flex-wrap items-center gap-x-8 gap-y-2 mt-6">
            <a
              href="https://selloflow.store/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm font-semibold text-purple-400 hover:text-purple-300 transition-colors duration-300"
            >
              {t("itCases.selloflow.viewSiteLabel")}
              <ArrowRight size={16} />
            </a>
          </div>
        </div>
            ...
            {components.map((comp, i) => (
              <FadeIn key={i} delay={0.1 + i * 0.08} y={30} blur={4}>
                <div className="featured-case-card border border-border rounded-2xl p-6 md:p-8" style={{ borderRadius: "16px" }}>
                  ...
                  {comp.image && (
                    <div className="mt-6 cursor-pointer" onClick={() => openModal(allImages, allImages.indexOf(comp.image!), t(comp.titleKey))}>
                      <GalleryImage
                        src={comp.image}
                        alt={t(comp.titleKey)}
                        width={1200}
                        ...
                        onOpen={() => openModal(allImages, allImages.indexOf(comp.image!), t(comp.titleKey))}
                      />
                    </div>
                  )}
                </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-lg mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("itCases.selloflow.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 relative" style={{ borderRadius: "20px" }}>
              ...
              <p className="text-foreground text-base leading-relaxed mb-6 whitespace-pre-line">
                {t("itCases.selloflow.reviewText")}
              </p>
              <div className="flex items-center gap-3">
                <ReviewAvatar name={t("itCases.selloflow.reviewAuthor")} size={32} />
                <p className="text-muted-foreground text-sm font-medium">
                  {t("itCases.selloflow.reviewAuthor")}
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="selloflow" />
