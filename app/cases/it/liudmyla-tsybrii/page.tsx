...
const components = [
  {
    titleKey: "itCases.liudmyla.component1Title",
    descKey: "itCases.liudmyla.component1Desc",
    images: ["/media/cases/liudmyla1.jpeg"],
    link: "https://www.liudmylatsybrii.com/",
    linkLabelKey: "itCases.liudmyla.viewSiteLabel",
  },
  {
    titleKey: "itCases.liudmyla.component2Title",
    descKey: "itCases.liudmyla.component2Desc",
    images: ["/media/cases/liudmyla2.webp"],
  },
  {
    titleKey: "itCases.liudmyla.component3Title",
    descKey: "itCases.liudmyla.component3Desc",
    images: ["/media/cases/liudmyla3.webp"],
  },
  {
    titleKey: "itCases.liudmyla.component4Title",
    descKey: "itCases.liudmyla.component4Desc",
    images: ["/media/cases/liudmyla4.webp"],
  },
];

const results = [
  "itCases.liudmyla.result1",
  "itCases.liudmyla.result2",
  "itCases.liudmyla.result3",
  "itCases.liudmyla.result4",
  "itCases.liudmyla.result5",
  "itCases.liudmyla.result6",
  "itCases.liudmyla.result7",
  "itCases.liudmyla.result8",
];
...
export default function LiudmylaTsybriiPage() {
  ...
  return (
    <article className="min-h-screen">
      ...
      <section ref={heroRef} className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(184, 134, 11, 0.15)",
                "--case-glow-strong": "rgba(184, 134, 11, 0.3)",
          ...
          >
            <div className="overflow-hidden rounded-2xl">
              ...
              >
                <Image
                  src="/media/cases/liudmyla-mocap-v2.webp"
                  alt={t("itCases.liudmyla.title")}
                  width={1200}
                  height={800}
          ...
          <div className="flex mt-8">
            <a
              href="https://www.liudmylatsybrii.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm font-semibold text-[#B8860B] hover:text-[#DAA520] transition-colors duration-300"
            >
              {t("itCases.liudmyla.viewSiteLabel")}
              <ArrowRight size={16} />
            </a>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(184, 134, 11, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
                ...
                <div className={`featured-case-card p-6 md:p-8 ${"link" in comp && comp.link ? "pb-10 md:pb-12" : ""}`} style={{ borderRadius: "16px" }}>
                  ...
                  {"link" in comp && comp.link && "linkLabelKey" in comp && comp.linkLabelKey && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-6 text-sm font-semibold text-[#B8860B] hover:text-[#DAA520] transition-colors duration-300"
                    >
                      {t(comp.linkLabelKey)}
                      <ArrowRight size={16} />
                    </a>
      ...
      <section className="py-16 px-4">
        <div className="max-w-lg mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("itCases.liudmyla.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 relative" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#B8860B]/40 mb-4" />
              <p className="text-foreground text-base leading-relaxed mb-6">
                {t("itCases.liudmyla.reviewText")}
              </p>
              <div className="flex items-center gap-3">
                <ReviewAvatar name={t("itCases.liudmyla.reviewAuthor")} size={32} />
                <p className="text-muted-foreground text-sm font-medium">
                  {t("itCases.liudmyla.reviewAuthor")}
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="liudmyla-tsybrii" />
