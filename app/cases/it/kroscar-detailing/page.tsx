...
const components: { titleKey: string; descKey: string; images?: string[]; link?: string; linkLabelKey?: string }[] = [
  {
...
const results = [
  "itCases.kroscarDetailing.result1",
  "itCases.kroscarDetailing.result2",
  "itCases.kroscarDetailing.result3",
  "itCases.kroscarDetailing.result4",
  "itCases.kroscarDetailing.result5",
  "itCases.kroscarDetailing.result6",
  "itCases.kroscarDetailing.result7",
  "itCases.kroscarDetailing.result8",
];
...
export default function KroscarDetailingPage() {
  ...
  return (
    <article className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground mb-4 block">
              {t("itCases.kroscarDetailing.category")}
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              {t("itCases.kroscarDetailing.title")}
            </h1>
            <p className="text-muted-foreground text-lg md:text-xl max-w-3xl leading-relaxed mb-12">
              {t("itCases.kroscarDetailing.description")}
            </p>
          </FadeIn>
          ...
          <div className="flex mt-8">
            <a
              href="https://deteling.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm font-semibold text-cyan-500 hover:text-[#22D3EE] transition-colors duration-300"
            >
              {t("itCases.kroscarDetailing.viewSiteLabel")}
              <ArrowRight size={16} />
            </a>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("itCases.kroscarDetailing.challenge")}
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t("itCases.kroscarDetailing.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(6, 182, 212, 0.12)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
                ...
                <div className="featured-case-card border border-border rounded-2xl p-6 md:p-8" style={{ borderRadius: "16px" }}>
                  ...
                  {comp.link && comp.linkLabelKey && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 mt-6 text-sm font-semibold text-cyan-500 hover:text-[#22D3EE] transition-colors duration-300"
                    >
                      {t(comp.linkLabelKey)}
                      <ArrowRight size={16} />
                    </a>
      ...
      <section className="py-16 px-4">
        <div className="max-w-lg mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("itCases.kroscarDetailing.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 relative" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-cyan-500/40 mb-4" />
              <p className="text-foreground text-base leading-relaxed mb-6 whitespace-pre-line">
                {t("itCases.kroscarDetailing.reviewText")}
              </p>
              <div className="flex items-center gap-3">
                <ReviewAvatar name={t("itCases.kroscarDetailing.reviewAuthor")} size={32} />
                <p className="text-muted-foreground text-sm font-medium">
                  {t("itCases.kroscarDetailing.reviewAuthor")}
                </p>
              </div>
            </div>
          </FadeIn>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="magnetic-button inline-flex items-center gap-2 border border-border text-cyan-500 hover:border-cyan-500/50 hover:bg-[#06B6D4]/10 hover:text-[#22D3EE] font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(6,182,212,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="kroscar-detailing" />
