...
const components = [
  {
    titleKey: "itCases.mdDental.component1Title",
    descKey: "itCases.mdDental.component1Desc",
    images: ["/media/cases/mddental-landing-1.webp"],
  },
  {
    titleKey: "itCases.mdDental.component2Title",
    descKey: "itCases.mdDental.component2Desc",
    images: ["/media/cases/mddental-services.webp"],
  },
  {
    titleKey: "itCases.mdDental.component3Title",
    descKey: "itCases.mdDental.component3Desc",
    images: ["/media/cases/mddental-trust.webp"],
  },
  {
    titleKey: "itCases.mdDental.component4Title",
    descKey: "itCases.mdDental.component4Desc",
    images: ["/media/cases/mddental-team.webp"],
  },
  {
    titleKey: "itCases.mdDental.component5Title",
    descKey: "itCases.mdDental.component5Desc",
    images: ["/media/cases/mddental-appointment.webp", "/media/cases/mddental-contacts.webp"],
  },
];

const results = [
  "itCases.mdDental.result1",
  "itCases.mdDental.result2",
  "itCases.mdDental.result3",
  "itCases.mdDental.result4",
  "itCases.mdDental.result5",
  "itCases.mdDental.result6",
  "itCases.mdDental.result7",
  "itCases.mdDental.result8",
];
...
export default function MDDentalPage() {
  ...
  return (
    <article className="min-h-screen">
      ...
      <section ref={heroRef} className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            ...
            style={
              {
                "--case-glow": "rgba(124, 91, 180, 0.12)",
                "--case-glow-strong": "rgba(146, 112, 202, 0.25)",
          ...
          >
            ...
            >
              <Image
                src="/media/cases/mddental-mocap.webp?v=2"
                alt={t("itCases.mdDental.title")}
                width={1536}
                height={1024}
          ...
          <div className="flex mt-6">
            <a
              href="https://md-dental.in.ua/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm font-semibold text-[#A18FCD] hover:text-[#C4B5E8] transition-colors duration-300"
            >
              {t("itCases.mdDental.viewSiteLabel")}
              <ArrowRight size={16} />
            </a>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(124, 91, 180, 0.12)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-lg mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("itCases.mdDental.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card border border-border rounded-2xl p-8 relative" style={{ borderRadius: "20px" }}>
              <Quote size={32} className="text-[#9270ca]/40 mb-4" />
              <p className="text-foreground text-base leading-relaxed mb-6 whitespace-pre-line">
                {t("itCases.mdDental.reviewText")}
              </p>
              <div className="flex items-center gap-3">
                <ReviewAvatar name={t("itCases.mdDental.reviewAuthor")} size={32} />
                <p className="text-muted-foreground text-sm font-medium">
                  {t("itCases.mdDental.reviewAuthor")}
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="md-dental" />
    </article>
  );
}
