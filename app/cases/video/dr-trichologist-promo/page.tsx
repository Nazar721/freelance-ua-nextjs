...
const resultItems = [
  "videoCases.drTrichologistPromo.result1",
  "videoCases.drTrichologistPromo.result2",
  "videoCases.drTrichologistPromo.result3",
  "videoCases.drTrichologistPromo.result4",
];
...
export default function DrTrichologistPromoPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.drTrichologistPromo.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-purple-500 bg-purple-500/10 px-3 py-1 rounded-full border border-purple-500/20">
                <Sparkles size={12} />
                AI Generated
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.drTrichologistPromo.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.drTrichologistPromo.subtitle")}
            </p>
          </FadeIn>
          ...
          >
            ...
            >
              <div className="flex justify-center">
                <div
                  className="relative rounded-xl overflow-hidden bg-background cursor-pointer group/thumb aspect-[9/16] max-h-[560px]"
                  onClick={() => openFullscreen("/media/cases/dr-trichologist-promo/hero.mp4")}
                >
                  <video
                    src="/media/cases/dr-trichologist-promo/hero.mp4#t=0.2"
                  ...
                  <div className="absolute top-3 right-3 flex gap-1.5">
                    ...
                    <span className="bg-purple-500/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-purple-500/30">
                      9:16
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.drTrichologistPromo.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.drTrichologistPromo.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.drTrichologistPromo.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.drTrichologistPromo.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.drTrichologistPromo.reviewTitle")}
            </h2>
          </FadeIn>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.drTrichologistPromo.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.drTrichologistPromo.reviewAuthor")} />
                  <p className="text-purple-500 font-semibold">{t("videoCases.drTrichologistPromo.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.drTrichologistPromo.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-purple-500 hover:border-purple-500/50 hover:bg-purple-500/10 hover:text-purple-400 font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(168,85,247,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="dr-trichologist-promo" section="video" />
