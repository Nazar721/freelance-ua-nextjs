...
const resultItems = [
  "videoCases.vladlenLisynkoInterview.result1",
  "videoCases.vladlenLisynkoInterview.result2",
  "videoCases.vladlenLisynkoInterview.result3",
  "videoCases.vladlenLisynkoInterview.result4",
];

const screenshots = [
  { src: "/media/cases/vladlen-lisynko-interview/screen-1.jpg", alt: "Владлен Лисинко — крупний план" },
  { src: "/media/cases/vladlen-lisynko-interview/screen-2.jpg", alt: "Учениця — крупний план" },
  { src: "/media/cases/vladlen-lisynko-interview/screen-3.jpg", alt: "Загальний кадр — обидва учасники в студії" },
];
...
export default function VladlenLisynkoInterviewPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.vladlenLisynkoInterview.category")}
              </span>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.vladlenLisynkoInterview.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.vladlenLisynkoInterview.subtitle")}
            </p>
          </FadeIn>
            ...
            >
              <div className="max-w-3xl mx-auto">
                <div className="relative rounded-xl overflow-hidden bg-background aspect-video cursor-pointer group/thumb">
                  <Image
                    src="/media/cases/vladlen-lisynko-interview/screen-3.jpg"
                    alt="Інтерв'ю з Владленом Лисинком"
                    width={1920}
                    height={1080}
                  ...
                  <div className="absolute bottom-3 left-3 right-3">
                    <a
                      href="https://t.me/FreelanceUADigitalAgency/161/432"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <div className="bg-[#A855F7]/90 backdrop-blur-md rounded-lg px-3 py-2 text-center border border-[#A855F7]/30 hover:bg-[#A855F7] transition-colors duration-300">
                        <span className="text-white text-[11px] md:text-xs font-semibold tracking-wide flex items-center justify-center gap-2">
                          <ExternalLink size={14} />
                          Дивитись на Telegram
                        </span>
                      </div>
                    </a>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.vladlenLisynkoInterview.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.vladlenLisynkoInterview.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.vladlenLisynkoInterview.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.vladlenLisynkoInterview.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {screenshots.map((s, i) => (
              <FadeIn key={i} delay={0.05 + i * 0.08} y={20} blur={4}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.vladlenLisynkoInterview.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                <Quote size={28} className="text-[#A855F7] mx-auto mb-4 opacity-50" />
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.vladlenLisynkoInterview.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.vladlenLisynkoInterview.reviewAuthor")} />
                  <p className="text-[#A855F7] font-semibold">{t("videoCases.vladlenLisynkoInterview.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.vladlenLisynkoInterview.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#A855F7] hover:border-[#A855F7]/50 hover:bg-[#A855F7]/10 hover:text-[#C084FC] font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(168,85,247,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="vladlen-lisynko-interview" section="video" />
    </article>
  );
}
