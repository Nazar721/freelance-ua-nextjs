...
const resultItems = [
  "videoCases.wineFestival.result1",
  "videoCases.wineFestival.result2",
  "videoCases.wineFestival.result3",
  "videoCases.wineFestival.result4",
];
...
export default function WineFestivalPage() {
  ...
  return (
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.wineFestival.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#A855F7] bg-[#A855F7]/10 px-3 py-1 rounded-full border border-[#A855F7]/20">
                <Play size={12} />
                YouTube
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.wineFestival.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.wineFestival.subtitle")}
            </p>
          </FadeIn>

          {/* Video Mockup — 2 videos side by side */}
          <div
            className="featured-case-card border border-border p-4 md:p-6 overflow-hidden"
            style={
              {
                borderRadius: "16px",
                "--case-glow": "rgba(168, 85, 247, 0.12)",
                "--case-glow-strong": "rgba(168, 85, 247, 0.25)",
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="relative rounded-xl overflow-hidden bg-background aspect-video max-h-[560px] cursor-pointer group/thumb"
                  ...
                  >
                    <video
                      ...
                      muted
                      preload="metadata"
                      poster={i === 0 ? "/media/cases/wine-festival/poster-1.jpg" : "/media/cases/wine-festival/poster-2.jpg"}
                    />
                    ...
                    <div className="absolute top-3 right-3 flex gap-1.5">
                      ...
                      <span className="bg-[#A855F7]/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-[#A855F7]/30">
                        16:9
                      </span>
                    </div>
                    ...
                    <div className="absolute bottom-3 left-3 right-3">
                      <div className="bg-black/40 backdrop-blur-md rounded-lg px-3 py-1.5 text-center border border-border">
                        <span className="text-white text-[11px] md:text-xs font-semibold tracking-wide">
                          {i === 0 ? t("videoCases.wineFestival.video1Label") : t("videoCases.wineFestival.video2Label")}
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.wineFestival.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.wineFestival.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.wineFestival.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.wineFestival.solution")}
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.wineFestival.video1Label")}
                </h2>
                <div
                  className="relative overflow-hidden rounded-xl border border-border bg-background max-w-lg mx-auto cursor-pointer group/video"
                ...
                >
                  <video
                    ...
                    preload="metadata"
                    muted
                    poster="/media/cases/wine-festival/poster-1.jpg"
                  />
                  <div className="absolute inset-0 bg-black/30 group-hover/video:bg-black/40 transition-all duration-300" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-white/10 group-hover/video:bg-white/20 backdrop-blur-sm rounded-full w-14 h-14 flex items-center justify-center border border-white/20 group-hover/video:scale-110 transition-all duration-300">
                      <Play size={26} className="text-white fill-white ml-1" />
                    </div>
                  </div>
                </div>
                <div className="mt-6 text-center">
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.wineFestival.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
          ...
          <FadeIn y={30} blur={8}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.wineFestival.video2Label")}
                </h2>
                <div
                  className="relative overflow-hidden rounded-xl border border-border bg-background max-w-lg mx-auto cursor-pointer group/video"
                ...
                >
                  <video
                    ...
                    preload="metadata"
                    muted
                    poster="/media/cases/wine-festival/poster-2.jpg"
                  />
                  <div className="absolute inset-0 bg-black/30 group-hover/video:bg-black/40 transition-all duration-300" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-white/10 group-hover/video:bg-white/20 backdrop-blur-sm rounded-full w-14 h-14 flex items-center justify-center border border-white/20 group-hover/video:scale-110 transition-all duration-300">
      ...
      {/* Social Proof — Video + Screenshot Reviews */}
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.wineFestival.reviewTitle")}
            </h2>
          </FadeIn>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Доказ використання — відео */}
            <FadeIn delay={0.1} y={30} blur={6}>
              <div className="featured-case-card overflow-hidden h-full relative" style={{ borderRadius: "20px" }}>
                ...
                <div
                  className="relative overflow-hidden bg-background cursor-pointer group/video w-full h-full min-h-[400px] rounded-3xl"
                  onClick={() => openFullscreen("/media/testimonials/video-5.mp4")}
                >
                  <div className="absolute inset-0 overflow-hidden rounded-3xl">
                    <video
                      ...
                      preload="metadata"
                      muted
                      poster="/media/testimonials/video-5-poster.jpg"
                    />
                  </div>
                  <div className="absolute inset-0 bg-black/30 group-hover/video:bg-black/40 transition-all duration-300" />
                  <div className="absolute inset-0 flex items-center justify-center">
            ...
            <FadeIn delay={0.2} y={30} blur={6}>
              <div className="featured-case-card overflow-hidden h-full" style={{ borderRadius: "20px" }}>
                <div className="p-4">
                  <Image
                    src="/media/testimonials/tg-screenshots/15-unnamed.webp"
                    alt="Відгук Elizabeth в Telegram"
                    width={600}
                    height={800}
                ...
                <div className="px-6 pb-6 md:px-8 md:pb-8 text-center">
                  ...
                  <p className="text-foreground text-base md:text-lg italic leading-relaxed mb-4">
                    &ldquo;Задоволена співпрацею! Відео відповідає задуму, не підвели зі строками. Дякую за оперативність та уважність до деталей&rdquo;
                  </p>
                  <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                    <ReviewAvatar name="Elizabeth" />
                    <p className="text-primary font-semibold text-sm">Elizabeth</p>
                  </div>
                </div>
              </div>
            </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.wineFestival.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-primary hover:border-[#6366F1]/50 hover:bg-primary/10 hover:text-indigo-400 font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(99,102,241,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="wine-festival" section="video" />
