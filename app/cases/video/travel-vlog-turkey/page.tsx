...
const resultItems = [
  "videoCases.travelVlogTurkey.result1",
  "videoCases.travelVlogTurkey.result2",
  "videoCases.travelVlogTurkey.result3",
  "videoCases.travelVlogTurkey.result4",
];

const screenshots = [
  { src: "/media/cases/travel-vlog-turkey/screen-1.jpg", alt: "Аерозйомка готелю біля моря" },
  { src: "/media/cases/travel-vlog-turkey/screen-2.jpg", alt: "Скелястий пляж з горами" },
  { src: "/media/cases/travel-vlog-turkey/screen-3.jpg", alt: "Вид з балкону на море" },
  { src: "/media/cases/travel-vlog-turkey/screen-4.jpg", alt: "Діти на водній гірці" },
  { src: "/media/cases/travel-vlog-turkey/screen-5.jpg", alt: "Емоції на водних гірках" },
  { src: "/media/cases/travel-vlog-turkey/screen-6.jpg", alt: "Чоловік на водній гірці" },
];
...
export default function TravelVlogTurkeyPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.travelVlogTurkey.category")}
              </span>
            ...
            >
              <div className="max-w-3xl mx-auto">
                <div className="relative rounded-xl overflow-hidden bg-background aspect-video cursor-pointer group/thumb">
                  <Image
                    src="/media/cases/travel-vlog-turkey/screen-1.jpg"
                    alt="Travel Vlog — Туреччина"
                    width={1280}
                    height={720}
                  ...
                  <a
                    href="https://t.me/FreelanceUADigitalAgency/161/1074"
                    target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.travelVlogTurkey.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.travelVlogTurkey.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.travelVlogTurkey.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.travelVlogTurkey.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.travelVlogTurkey.reviewTitle")}
            </h2>
          </FadeIn>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.travelVlogTurkey.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.travelVlogTurkey.reviewAuthor")} />
                  <p className="text-[#FB923C] font-semibold">{t("videoCases.travelVlogTurkey.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.travelVlogTurkey.teamMember")}
          </p>
        </div>
      </section>
      ...
      <RelatedProjectsSection currentSlug="travel-vlog-turkey" section="video" />
    </article>
  );
}
