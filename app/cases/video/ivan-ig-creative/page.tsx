...
const resultItems = [
  "videoCases.ivanIgCreative.result1",
  "videoCases.ivanIgCreative.result2",
  "videoCases.ivanIgCreative.result3",
  "videoCases.ivanIgCreative.result4",
];
...
export default function IvanIgCreativePage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.ivanIgCreative.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-indigo-500 bg-indigo-500/10 px-3 py-1 rounded-full border border-indigo-500/20">
                <Sparkles size={12} />
                AI Generated
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.ivanIgCreative.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.ivanIgCreative.subtitle")}
            </p>
          </FadeIn>

          {/* Hero Videos — two videos side by side */}
          <div
            className="featured-case-card border border-border p-4 md:p-6 overflow-hidden"
            style={
              {
                borderRadius: "16px",
                "--case-glow": "rgba(99, 102, 241, 0.12)",
                "--case-glow-strong": "rgba(99, 102, 241, 0.25)",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
                ...
                >
                  ...
                  <div className="absolute top-2 right-2 flex gap-1.5">
                    ...
                    <span className="bg-indigo-500/80 backdrop-blur-md text-white text-[9px] font-medium px-1.5 py-0.5 rounded-full border border-indigo-500/30">
                      9:16
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.ivanIgCreative.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.ivanIgCreative.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.ivanIgCreative.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.ivanIgCreative.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.ivanIgCreative.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/ivan-ig-creative/screenshot.webp"
                  alt="Відгук клієнта Іван"
                  width={500}
                  height={600}
          ...
          <FadeIn delay={0.2} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden mt-6" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                <Quote size={28} className="text-indigo-500 mx-auto mb-4 opacity-50" />
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.ivanIgCreative.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.ivanIgCreative.reviewAuthor")} />
                  <p className="text-indigo-500 font-semibold">{t("videoCases.ivanIgCreative.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.ivanIgCreative.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-indigo-500 hover:border-indigo-500/50 hover:bg-indigo-500/10 hover:text-indigo-400 font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(99,102,241,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="ivan-ig-creative" section="video" />
