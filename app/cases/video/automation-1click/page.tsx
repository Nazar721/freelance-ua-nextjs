...
const resultItems = [
  "videoCases.automation1click.result1",
  "videoCases.automation1click.result2",
  "videoCases.automation1click.result3",
  "videoCases.automation1click.result4",
];

const screenshots = [
  { src: "/media/cases/automation-1click/screenshot-1.jpg", alt: "Спікер з мікрофоном RØDE — Автоматизація в 1 клік" },
  { src: "/media/cases/automation-1click/screenshot-2.jpg", alt: "Сітка — автоматизація, Telegram-бот, спікер" },
  { src: "/media/cases/automation-1click/screenshot-3.jpg", alt: "Тайтл — Як створити автоматизацію для бізнесу" },
  { src: "/media/cases/automation-1click/screenshot-4.jpg", alt: "Спікер з анімованим персонажем" },
  { src: "/media/cases/automation-1click/screenshot-5.jpg", alt: "Хто потребує автоматизацій та навіщо" },
  { src: "/media/cases/automation-1click/screenshot-6.jpg", alt: "3 типи автоматизацій" },
];
...
export default function Automation1clickPage() {
  ...
  return (
    <article className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.automation1click.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#F59E0B] bg-[#F59E0B]/10 px-3 py-1 rounded-full border border-[#F59E0B]/20">
                <Play size={12} />
                YouTube
              </span>
            </div>
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.automation1click.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.automation1click.subtitle")}
            </p>
          </FadeIn>
          ...
          <div
            ...
            style={
              {
                borderRadius: "16px",
                "--case-glow": "rgba(245, 158, 11, 0.12)",
                "--case-glow-strong": "rgba(245, 158, 11, 0.25)",
            ...
            >
              <div className="max-w-3xl mx-auto">
                <div className="relative rounded-xl overflow-hidden bg-background aspect-video cursor-pointer group/thumb">
                  <Image
                    src="/media/cases/automation-1click/screenshot-3.jpg"
                    alt="Як створити автоматизацію для бізнесу в 1 клік"
                    width={1280}
                    height={720}
                  ...
                  <div className="absolute top-3 right-3 flex gap-1.5">
                    ...
                    <span className="bg-[#F59E0B]/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-[#F59E0B]/30">
                      16:9
                    </span>
                  </div>
                  ...
                  <a
                    href="https://t.me/FreelanceUADigitalAgency/161/430"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="absolute bottom-3 left-3 right-3"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="bg-[#F59E0B]/90 backdrop-blur-md rounded-lg px-3 py-2 text-center border border-[#F59E0B]/30 hover:bg-[#F59E0B] transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.automation1click.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.automation1click.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.automation1click.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.automation1click.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(245, 158, 11, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.automation1click.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                <Quote size={28} className="text-[#F59E0B] mx-auto mb-4 opacity-50" />
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.automation1click.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.automation1click.reviewAuthor")} />
                  <p className="text-[#F59E0B] font-semibold">{t("videoCases.automation1click.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.automation1click.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#F59E0B] hover:border-[#F59E0B]/50 hover:bg-[#F59E0B]/10 hover:text-[#FCD34D] font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(245,158,11,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="automation-1click" section="video" />
    </article>
  );
}
