          ...
          >
            ...
            >
              <div className="flex justify-center">
                ...
                >
                  <video
                    src="/media/cases/ai-spring-fashion/hero.mp4#t=0.2"
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#F472B6] hover:border-[#F472B6]/50 hover:bg-[#F472B6]/10 hover:text-[#F9A8D4] font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(244,114,182,0.12)]"
            >
