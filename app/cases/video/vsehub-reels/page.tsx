...
const resultItems = [
  "videoCases.vsehub.result1",
  "videoCases.vsehub.result2",
  "videoCases.vsehub.result3",
  "videoCases.vsehub.result4",
];
...
export default function VsehubReelsPage() {
    ...
    <article className="min-h-screen">
          ...
          >
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                {[
                  { src: "/media/cases/vsehub-reels/hero.mp4", poster: "/media/cases/vsehub-reels/hero-poster.jpg" },
                  { src: "/media/cases/vsehub-reels/process-1.mp4", poster: "/media/cases/vsehub-reels/process-1-poster.jpg" },
                  { src: "/media/cases/vsehub-reels/process-2.mp4", poster: "/media/cases/vsehub-reels/process-2-poster.jpg" },
                ].map((video, i) => (
                  <div
                    key={i}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.vsehub.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.vsehub.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.vsehub.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.vsehub.solution")}
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                ...
                <div className="mt-6 text-center">
                  <p className="text-[#F59E0B] font-semibold mb-2 flex items-center gap-2 justify-center">
                    <YouTubeIcon size={16} />
                    {t("videoCases.vsehub.clientRole")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.vsehub.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.vsehub.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/vsehub-reels/screenshot.webp"
                  alt="Відгук VseHub"
                  width={400}
                  height={600}
              ...
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.vsehub.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.vsehub.reviewAuthor")} />
                  <p className="text-[#F59E0B] font-semibold">{t("videoCases.vsehub.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.vsehub.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#F59E0B] hover:border-[#F59E0B]/50 hover:bg-[#F59E0B]/10 hover:text-[#FBBF24] font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(245,158,11,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="vsehub-reels" section="video" />
