        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#F59E0B] hover:border-[#F59E0B]/50 hover:bg-[#F59E0B]/10 hover:text-[#FBBF24] font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(245,158,11,0.12)]"
            >
