...
const resultItems = [
  "videoCases.barvyInterior.result1",
  "videoCases.barvyInterior.result2",
  "videoCases.barvyInterior.result3",
  "videoCases.barvyInterior.result4",
];
...
export default function BarvyInteriorAiReelsPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.barvyInterior.category")}
              </span>
            ...
            >
              <div className="flex justify-center">
                <div
                  ...
                  onClick={() => openFullscreen("/media/cases/barvy-interior-ai-reels/hero.mp4")}
                >
                  <video
                    src="/media/cases/barvy-interior-ai-reels/hero.mp4#t=0.2"
                    poster="/media/cases/barvy-interior-ai-reels/poster.webp"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.barvyInterior.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.barvyInterior.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.barvyInterior.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.barvyInterior.solution")}
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.barvyInterior.clientName")}
                </h2>
                <div className="mt-6 text-center">
                  <p className="text-[#A855F7] font-semibold mb-2 flex items-center gap-2 justify-center">
                    <Sparkles size={16} />
                    {t("videoCases.barvyInterior.clientRole")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.barvyInterior.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.barvyInterior.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background p-6 md:p-8">
                <Image
                  src="/media/cases/barvy-interior-ai-reels/review.webp"
                  alt="Відгук Катерини — BARVY Interior"
                  width={902}
                  height={244}
          ...
          {/* Text review */}
          <FadeIn delay={0.2} y={30} blur={6} className="mt-6">
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.barvyInterior.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.barvyInterior.reviewAuthor")} />
                  <p className="text-[#A855F7] font-semibold">{t("videoCases.barvyInterior.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.barvyInterior.teamMember")}
          </p>
        </div>
      </section>
      ...
      <RelatedProjectsSection currentSlug="barvy-interior-ai-reels" section="video" />
