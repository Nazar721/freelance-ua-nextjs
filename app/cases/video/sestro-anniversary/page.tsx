...
const resultItems = [
  "videoCases.sestroAnniversary.result1",
  "videoCases.sestroAnniversary.result2",
  "videoCases.sestroAnniversary.result3",
  "videoCases.sestroAnniversary.result4",
];
...
export default function SestroAnniversaryPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.sestroAnniversary.category")}
              </span>
            ...
            >
              <div className="flex justify-center">
                <div
                  ...
                  onClick={() => openFullscreen("/media/cases/sestro-anniversary/hero.mp4")}
                >
                  <video
                    src="/media/cases/sestro-anniversary/hero.mp4#t=0.2"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.sestroAnniversary.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.sestroAnniversary.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.sestroAnniversary.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.sestroAnniversary.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.sestroAnniversary.clientTitle")}
            </h2>
          </FadeIn>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 flex flex-col items-center gap-6">
                <div className="w-full overflow-hidden rounded-2xl border border-border">
                  <Image
                    src="/media/brands/sestro.jpg"
                    alt="Sestro Beauty Studio logo"
                    width={800}
                    height={200}
                ...
                <div className="text-center md:text-left">
                  <p className="text-pink-500 font-semibold text-lg mb-1">
                    {t("videoCases.sestroAnniversary.clientName")}
                  </p>
                  <p className="text-muted-foreground text-sm mb-3">
                    {t("videoCases.sestroAnniversary.clientRole")}
                  </p>
                  <p className="text-foreground leading-relaxed">
                    {t("videoCases.sestroAnniversary.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.sestroAnniversary.reviewTitle")}
            </h2>
          </FadeIn>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.sestroAnniversary.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.sestroAnniversary.reviewAuthor")} />
                  <p className="text-pink-500 font-semibold">{t("videoCases.sestroAnniversary.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.sestroAnniversary.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-pink-500 hover:border-pink-500/50 hover:bg-pink-500/10 hover:text-pink-400 font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(244,114,182,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="sestro-anniversary" section="video" />
