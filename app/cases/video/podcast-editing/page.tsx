...
const resultItems = [
  "videoCases.podcastEditing.result1",
  "videoCases.podcastEditing.result2",
  "videoCases.podcastEditing.result3",
  "videoCases.podcastEditing.result4",
];

const screenshots = [
  { src: "/media/cases/podcast-editing/screenshot-1.jpg", alt: "The Strategic Hotbox — тайтл" },
  { src: "/media/cases/podcast-editing/screenshot-2.jpg", alt: "Jozell Byron — Сент-Вінсент та Гренадіни" },
  { src: "/media/cases/podcast-editing/screenshot-3.jpg", alt: "Сітка учасників — 6 спікерів" },
  { src: "/media/cases/podcast-editing/screenshot-4.jpg", alt: "Heloisa Helena Lopes — Бразилія" },
  { src: "/media/cases/podcast-editing/screenshot-5.jpg", alt: "Сітка учасників — Нігерія, Домінікана" },
  { src: "/media/cases/podcast-editing/screenshot-6.jpg", alt: "Washington Ferreira Nascimento — субтитри" },
];
  ...
  return (
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.podcastEditing.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#EF4444] bg-[#EF4444]/10 px-3 py-1 rounded-full border border-[#EF4444]/20">
                <Play size={12} />
                YouTube
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.podcastEditing.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.podcastEditing.subtitle")}
            </p>
          </FadeIn>
            ...
            >
              <div className="max-w-3xl mx-auto">
                <div className="relative rounded-xl overflow-hidden bg-background aspect-video cursor-pointer group/thumb">
                  <Image
                    src="/media/cases/podcast-editing/screenshot-1.jpg"
                    alt="The Strategic Hotbox"
                    width={1280}
                    height={720}
                  ...
                  <div className="absolute top-3 right-3 flex gap-1.5">
                    ...
                    <span className="bg-[#EF4444]/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-[#EF4444]/30">
                      16:9
                    </span>
                  </div>
                  ...
                  <a
                    href="https://t.me/FreelanceUADigitalAgency/161/1036"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="absolute bottom-3 left-3 right-3"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="bg-[#EF4444]/90 backdrop-blur-md rounded-lg px-3 py-2 text-center border border-[#EF4444]/30 hover:bg-[#EF4444] transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.podcastEditing.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.podcastEditing.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.podcastEditing.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.podcastEditing.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(239, 68, 68, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.podcastEditing.reviewTitle")}
            </h2>
          </FadeIn>

          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/podcast-editing/review-avatar.jpg"
                  alt="Відгук Angelina"
                  width={400}
                  height={600}
              ...
              <div className="p-8 md:p-10 text-center">
                <Quote size={28} className="text-[#EF4444] mx-auto mb-4 opacity-50" />
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.podcastEditing.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.podcastEditing.reviewAuthor")} />
                  <p className="text-[#EF4444] font-semibold">{t("videoCases.podcastEditing.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.podcastEditing.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#EF4444] hover:border-[#EF4444]/50 hover:bg-[#EF4444]/10 hover:text-[#FCA5A5] font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(239,68,68,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="podcast-editing" section="video" />
    </article>
  );
}
