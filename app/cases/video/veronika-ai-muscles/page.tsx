...
const resultItems = [
  "videoCases.veronikaAiMuscles.result1",
  "videoCases.veronikaAiMuscles.result2",
  "videoCases.veronikaAiMuscles.result3",
  "videoCases.veronikaAiMuscles.result4",
];
...
export default function VeronikaAiMusclesPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.veronikaAiMuscles.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-green-500 bg-[#22C55E]/10 px-3 py-1 rounded-full border border-[#22C55E]/20">
                <Sparkles size={12} />
                AI Generated
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.veronikaAiMuscles.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.veronikaAiMuscles.subtitle")}
            </p>
          </FadeIn>
              ...
              <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
                ...
                >
                  ...
                  <div className="absolute top-2 right-2 flex gap-1.5">
                    ...
                    <span className="bg-[#22C55E]/80 backdrop-blur-md text-white text-[9px] font-medium px-1.5 py-0.5 rounded-full border border-green-500/30">
                      9:16
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.veronikaAiMuscles.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.veronikaAiMuscles.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.veronikaAiMuscles.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.veronikaAiMuscles.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.veronikaAiMuscles.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/veronika-ai-muscles/screenshot.webp"
                  alt="Відгук Вероніки"
                  width={500}
                  height={600}
            ...
            <div className="featured-case-card overflow-hidden mt-6" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.veronikaAiMuscles.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.veronikaAiMuscles.reviewAuthor")} />
                  <p className="text-green-500 font-semibold">{t("videoCases.veronikaAiMuscles.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.veronikaAiMuscles.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-green-500 hover:border-green-500/50 hover:bg-[#22C55E]/10 hover:text-[#4ADE80] font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(34,197,94,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="veronika-ai-muscles" section="video" />
