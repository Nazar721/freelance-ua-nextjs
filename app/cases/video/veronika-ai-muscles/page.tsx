        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-green-500 hover:border-green-500/50 hover:bg-[#22C55E]/10 hover:text-[#4ADE80] font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(34,197,94,0.12)]"
            >
