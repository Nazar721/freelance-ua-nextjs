                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div className="text-center md:text-left">
                    ...
                    <Link
                      ...
                      className="group inline-flex items-center gap-2 rounded-xl border border-[#EC4899]/20 bg-[#EC4899]/10 px-5 py-3 font-semibold text-[#EC4899] transition-all duration-300 hover:-translate-y-0.5 hover:border-[#EC4899]/40 hover:bg-[#EC4899]/20"
                    >
