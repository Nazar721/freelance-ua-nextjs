...
const resultItems = [
  "videoCases.evaCodeReels.result1",
  "videoCases.evaCodeReels.result2",
  "videoCases.evaCodeReels.result3",
  "videoCases.evaCodeReels.result4",
];
...
export default function EvaCodeReelsPage() {
  ...
  return (
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.evaCodeReels.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#EC4899] bg-[#EC4899]/10 px-3 py-1 rounded-full border border-[#EC4899]/20">
                <Boxes size={12} />
                E.V.A. CODE™
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.evaCodeReels.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.evaCodeReels.subtitle")}
            </p>
          </FadeIn>

          {/* Video Mockup — single video */}
          <div
          ...
          >
            ...
            >
              <div className="flex justify-center">
                <div
                  className="relative rounded-xl overflow-hidden bg-background aspect-[9/16] max-h-[560px] mx-auto cursor-pointer group/thumb"
                ...
                >
                  ...
                  <div className="absolute top-3 right-3 flex gap-1.5">
                    ...
                    <span className="bg-[#EC4899]/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-[#EC4899]/30">
                      9:16
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.evaCodeReels.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.evaCodeReels.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.evaCodeReels.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.evaCodeReels.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* Cross-link: we built the system too */}
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="relative overflow-hidden rounded-xl border border-border bg-background w-full md:w-2/5 shrink-0">
                    <Image
                      src="/media/cases/eva-web.webp?v=2"
                      alt="E.V.A. CODE™ — цифрова екосистема"
                      width={800}
                      height={500}
                  ...
                  <div className="text-center md:text-left">
                    <h2 className="text-2xl font-bold text-foreground mb-3 flex items-center gap-3 justify-center md:justify-start">
                      <Boxes size={22} className="text-[#EC4899]" />
                      {t("videoCases.evaCodeReels.relatedItTitle")}
                    </h2>
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      {t("videoCases.evaCodeReels.relatedItDesc")}
                    </p>
                    <Link
                      href="/cases/it/eva-code"
                      className="group inline-flex items-center gap-2 rounded-xl border border-[#EC4899]/20 bg-[#EC4899]/10 px-5 py-3 font-semibold text-[#EC4899] transition-all duration-300-0.5 hover:border-[#EC4899]/40 hover:bg-[#EC4899]/20"
                    >
                      {t("videoCases.evaCodeReels.relatedItCta")}
                      <ArrowRight
                        size={16}
                        className="transition-transform duration-300-1"
                      />
                    </Link>
                  </div>
                </div>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.evaCodeReels.clientName")}
                </h2>
                <div className="mt-6 text-center">
                  <p className="text-[#EC4899] font-semibold mb-2">
                    {t("videoCases.evaCodeReels.clientRole")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.evaCodeReels.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.evaCodeReels.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background p-4">
                <div
                  className="relative rounded-xl overflow-hidden aspect-[9/16] w-full max-w-[280px] cursor-pointer group/thumb"
                  onClick={() => openFullscreen("/media/testimonials/video-1.mp4")}
                >
                  <video
                    src="/media/testimonials/video-1.mp4#t=0.2"
                    className="w-full h-full object-cover"
                    muted
                    preload="metadata"
                  />
                  ...
                  <div className="absolute top-3 right-3">
                    <span className="bg-[#EC4899]/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-[#EC4899]/30">
                      {t("videoCases.evaCodeReels.reviewVideoLabel")}
                    </span>
                  </div>
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-white/10 group-hover/thumb:bg-white/20 backdrop-blur-sm rounded-full w-14 h-14 flex items-center justify-center border border-white/20 group-hover/thumb:scale-110 group-hover/thumb:border-white/40 transition-all duration-300 shadow-lg shadow-black/20">
              ...
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("testimonial.21.text")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.evaCodeReels.reviewAuthor")} />
                  <p className="text-[#EC4899] font-semibold">
                    {t("videoCases.evaCodeReels.reviewAuthor")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.evaCodeReels.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#EC4899] hover:border-[#EC4899]/50 hover:bg-[#EC4899]/10 hover:text-[#F472B6] font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(236,72,153,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="eva-code-reels" section="video" />
