...
const resultItems = [
  "videoCases.nikitaSheremet.result1",
  "videoCases.nikitaSheremet.result2",
  "videoCases.nikitaSheremet.result3",
  "videoCases.nikitaSheremet.result4",
];
...
export default function NikitaSheremetPage() {
  ...
  return (
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.nikitaSheremet.category")}
              </span>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.nikitaSheremet.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.nikitaSheremet.subtitle")}
            </p>
          </FadeIn>

          {/* Video Mockup Grid — 4 videos side by side */}
          <div
            className="featured-case-card border border-border p-4 md:p-6 overflow-hidden"
            style={
              {
                borderRadius: "16px",
                "--case-glow": "rgba(225, 48, 108, 0.12)",
                "--case-glow-strong": "rgba(225, 48, 108, 0.25)",
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                {[
                  ...
                  "/media/cases/nikita-sheremet-crypto/hero.mp4",
                ].map((src, i) => (
                  <div
                    key={i}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.nikitaSheremet.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.nikitaSheremet.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.nikitaSheremet.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.nikitaSheremet.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(225, 48, 108, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.nikitaSheremet.clientName")}
                </h2>
                <div className="relative overflow-hidden rounded-xl border border-border bg-background max-w-lg mx-auto">
                  <Image
                    src="/media/cases/nikita-sheremet-crypto/avatar.jpeg"
                    alt="Профіль Нікіти Шеремета — Instagram"
                    width={800}
                    height={400}
                ...
                <div className="mt-6 text-center">
                  <p className="text-[#E1306C] font-semibold mb-2 flex items-center gap-2 justify-center">
                    ...
                    {t("videoCases.nikitaSheremet.clientRole")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.nikitaSheremet.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.nikitaSheremet.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/nikita-sheremet-crypto/screenshot.webp"
                  alt="Відгук Нікіти Шеремета"
                  width={400}
                  height={600}
              ...
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.nikitaSheremet.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.nikitaSheremet.reviewAuthor")} />
                  <p className="text-primary font-semibold">{t("videoCases.nikitaSheremet.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="nikita-sheremet" section="video" />
