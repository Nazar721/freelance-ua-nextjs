...
const videos = [
  { src: "/media/cases/auto-edits/video-1.mp4", poster: "/media/cases/auto-edits/preview-1.jpg", label: "Honda" },
  { src: "/media/cases/auto-edits/video-2.mp4", poster: "/media/cases/auto-edits/preview-2.jpg", label: "Audi A6" },
  { src: "/media/cases/auto-edits/video-3.mp4", poster: "/media/cases/auto-edits/preview-3.jpg", label: "Infiniti FX" },
  { src: "/media/cases/auto-edits/video-4.mp4", poster: "/media/cases/auto-edits/preview-4.jpg", label: "Mini Cooper" },
  { src: "/media/cases/auto-edits/video-5.mp4", poster: "/media/cases/auto-edits/preview-5.jpg", label: "BMW 3" },
];

const resultItems = [
  "videoCases.autoEdits.result1",
  "videoCases.autoEdits.result2",
  "videoCases.autoEdits.result3",
  "videoCases.autoEdits.result4",
];
...
export default function AutoEditsReelsPage() {
    ...
    <article className="min-h-screen">
      ...
      <section ref={heroRef} className="py-8 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.autoEdits.category")}
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.autoEdits.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.autoEdits.subtitle")}
            </p>
          </FadeIn>

          {/* Video Grid — Block 1: 3 videos */}
          <div
            className="featured-case-card border border-border p-4 md:p-6 overflow-hidden mb-4"
            style={
              {
                borderRadius: "16px",
            ...
            >
              <div className="grid grid-cols-3 gap-3">
                {videos.slice(0, 3).map((v, i) => (
                  <div
                    key={i}
                    className="relative rounded-xl overflow-hidden bg-background cursor-pointer group/thumb max-h-[560px]"
                    onClick={() => openFullscreen(v.src)}
                  >
                    <video
                      src={v.src}
                      poster={v.poster}
                      ...
                      preload="metadata"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/10 to-black/20 group-hover/thumb:from-black/80 group-hover/thumb:via-black/20 group-hover/thumb:to-black/30 transition-all duration-300" />
          ...
          {/* Video Grid — Block 2: 2 videos */}
          <div
            className="featured-case-card border border-border p-4 md:p-6 overflow-hidden max-w-2/3"
            style={
              {
                borderRadius: "16px",
                "--case-glow": "rgba(6, 182, 212, 0.12)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                <AlertTriangle size={20} className="text-[#06B6D4] shrink-0" />
                {t("videoCases.autoEdits.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.autoEdits.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.autoEdits.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.autoEdits.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(6, 182, 212, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.autoEdits.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#06B6D4] hover:border-[#06B6D4]/50 hover:bg-[#06B6D4]/10 hover:text-[#22D3EE] font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(6,182,212,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="auto-edits-reels" section="video" />
