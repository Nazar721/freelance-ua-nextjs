        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-yellow-500 hover:border-yellow-500/50 hover:bg-yellow-500/10 hover:text-yellow-400 font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(250,204,21,0.12)]"
            >
