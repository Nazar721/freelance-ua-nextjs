...
const resultItems = [
  "videoCases.sheglamPromo.result1",
  "videoCases.sheglamPromo.result2",
  "videoCases.sheglamPromo.result3",
  "videoCases.sheglamPromo.result4",
];
...
export default function SheglamPromoPage() {
    ...
    <article className="min-h-screen">
            ...
            >
              <div className="flex justify-center">
                <div
                  ...
                  onClick={() => openFullscreen("/media/cases/sheglam-promo/hero.mp4")}
                >
                  <video
                    src="/media/cases/sheglam-promo/hero.mp4#t=0.2"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.sheglamPromo.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.sheglamPromo.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.sheglamPromo.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.sheglamPromo.solution")}
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <FadeIn y={30} blur={8}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/sheglam-promo/screenshot.jpg"
                  alt="SHEGLAM Instagram"
                  width={600}
                  height={400}
              ...
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.sheglamPromo.clientName")}
                </h2>
                <div className="mt-6 text-center">
                  <p className="text-[#EC4899] font-semibold mb-2">
                    {t("videoCases.sheglamPromo.clientRole")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.sheglamPromo.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.sheglamPromo.reviewTitle")}
            </h2>
          </FadeIn>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.sheglamPromo.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.sheglamPromo.reviewAuthor")} />
                  <p className="text-[#EC4899] font-semibold">{t("videoCases.sheglamPromo.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.sheglamPromo.teamMember")}
          </p>
        </div>
      </section>
      ...
      <RelatedProjectsSection currentSlug="sheglam-promo" section="video" />
