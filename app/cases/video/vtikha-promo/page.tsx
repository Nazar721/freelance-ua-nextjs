...
const resultItems = [
  "videoCases.vtikha.result1",
  "videoCases.vtikha.result2",
  "videoCases.vtikha.result3",
  "videoCases.vtikha.result4",
];
...
export default function VtikhaPromoPage() {
    ...
    <article className="min-h-screen">
          ...
          >
            ...
            >
              <div className="flex justify-center">
                <div
                  className="relative rounded-xl overflow-hidden bg-background aspect-square max-h-[560px] mx-auto cursor-pointer group/thumb"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.vtikha.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.vtikha.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.vtikha.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.vtikha.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.vtikha.reviewTitle")}
            </h2>
          </FadeIn>

          {/* Two review screenshots */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <FadeIn delay={0.1} y={30} blur={6}>
              <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
                <div className="relative overflow-hidden flex justify-center bg-background">
                  <Image
                    src="/media/cases/vtikha-promo/review-emotions.webp"
                    alt="Емоційний відгук Volodymyr Takudis"
                    width={500}
                    height={600}
            ...
            <FadeIn delay={0.2} y={30} blur={6}>
              <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
                <div className="relative overflow-hidden flex justify-center bg-background">
                  <Image
                    src="/media/cases/vtikha-promo/review-full.jpg"
                    alt="Повний відгук Volodymyr Takudis"
                    width={500}
                    height={600}
                    className="w-full max-w-md h-auto object-contain"
                    draggable={false}
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.vtikha.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.vtikha.reviewAuthor")} />
                  <p className="text-[#A855F7] font-semibold">{t("videoCases.vtikha.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.vtikha.teamMember")}
          </p>
        </div>
      </section>
      ...
      <RelatedProjectsSection currentSlug="vtikha-promo" section="video" />
