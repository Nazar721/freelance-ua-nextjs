...
const resultItems = [
  "videoCases.serhiiYarmolenko.result1",
  "videoCases.serhiiYarmolenko.result2",
  "videoCases.serhiiYarmolenko.result3",
  "videoCases.serhiiYarmolenko.result4",
];

const screenshots = [
  { src: "/media/cases/serhii-yarmolenko-video-lesson/screen-1.jpg", alt: "Кадр з відео уроку — інтро" },
  { src: "/media/cases/serhii-yarmolenko-video-lesson/screen-2.jpg", alt: "Кадр з відео уроку — основний блок" },
  { src: "/media/cases/serhii-yarmolenko-video-lesson/screen-3.jpg", alt: "Кадр з відео уроку — графіка" },
  { src: "/media/cases/serhii-yarmolenko-video-lesson/screen-4.jpg", alt: "Кадр з відео уроку — розбір теми" },
  { src: "/media/cases/serhii-yarmolenko-video-lesson/screen-5.jpg", alt: "Кадр з відео уроку — візуальні акценти" },
  { src: "/media/cases/serhii-yarmolenko-video-lesson/screen-6.jpg", alt: "Кадр з відео уроку — титри" },
  { src: "/media/cases/serhii-yarmolenko-video-lesson/screen-7.jpg", alt: "Кадр з відео уроку — завершення" },
];
...
export default function SerhiiYarmolenkoVideoLessonPage() {
  ...
  return (
    <article className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.serhiiYarmolenko.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#FB923C] bg-[#FB923C]/10 px-3 py-1 rounded-full border border-[#FB923C]/20">
                <Play size={12} />
                YouTube
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.serhiiYarmolenko.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.serhiiYarmolenko.subtitle")}
            </p>
          </FadeIn>
          ...
          <div
            ...
            style={
              {
                borderRadius: "16px",
                "--case-glow": "rgba(251, 146, 60, 0.12)",
                "--case-glow-strong": "rgba(251, 146, 60, 0.25)",
            ...
            >
              <div className="max-w-3xl mx-auto">
                <div className="relative rounded-xl overflow-hidden bg-background aspect-video cursor-pointer group/thumb">
                  <Image
                    src="/media/cases/serhii-yarmolenko-video-lesson/screen-1.jpg"
                    alt="Відео урок Сергія Ярмоленка"
                    width={1280}
                    height={720}
                  ...
                  <div className="absolute top-3 right-3 flex gap-1.5">
                    ...
                    <span className="bg-[#FB923C]/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-[#FB923C]/30">
                      16:9
                    </span>
                  </div>
                  ...
                  <a
                    href="https://t.me/FreelanceUADigitalAgency/161/1098"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="absolute bottom-3 left-3 right-3"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="bg-[#FB923C]/90 backdrop-blur-md rounded-lg px-3 py-2 text-center border border-[#FB923C]/30 hover:bg-[#FB923C] transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.serhiiYarmolenko.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.serhiiYarmolenko.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.serhiiYarmolenko.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.serhiiYarmolenko.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(251, 146, 60, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.serhiiYarmolenko.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                <Quote size={28} className="text-[#FB923C] mx-auto mb-4 opacity-50" />
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.serhiiYarmolenko.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.serhiiYarmolenko.reviewAuthor")} />
                  <p className="text-[#FB923C] font-semibold">{t("videoCases.serhiiYarmolenko.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.team.andriiMotion")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#FB923C] hover:border-[#FB923C]/50 hover:bg-[#FB923C]/10 hover:text-[#FDBA74] font-semibold px-8 py-4 rounded-full transition-all duration-500-0.5 hover:shadow-[0_0_40px_rgba(251,146,60,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="serhii-yarmolenko-video-lesson" section="video" />
    </article>
  );
}
