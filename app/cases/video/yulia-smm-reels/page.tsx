...
const resultItems = [
  "videoCases.yuliaSmm.result1",
  "videoCases.yuliaSmm.result2",
  "videoCases.yuliaSmm.result3",
  "videoCases.yuliaSmm.result4",
];
...
export default function YuliaSmmReelsPage() {
    ...
    <article className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.yuliaSmm.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.yuliaSmm.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.yuliaSmm.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.yuliaSmm.solution")}
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.yuliaSmm.clientName")}
                </h2>
                <div className="mt-6 text-center">
                  <p className="text-[#F59E0B] font-semibold mb-2">
                    {t("videoCases.yuliaSmm.clientRole")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.yuliaSmm.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.yuliaSmm.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/yulia-smm-reels/screenshot.webp"
                  alt="Відгук Юлії Хиленко"
                  width={500}
                  height={600}
            ...
            <div className="featured-case-card overflow-hidden mt-6" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.yuliaSmm.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.yuliaSmm.reviewAuthor")} />
                  <p className="text-[#F59E0B] font-semibold">{t("videoCases.yuliaSmm.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.yuliaSmm.teamMember")}
          </p>
        </div>
      </section>
      ...
      <RelatedProjectsSection currentSlug="yulia-smm-reels" section="video" />
