...
const resultItems = [
  "videoCases.aiIceCream.result1",
  "videoCases.aiIceCream.result2",
  "videoCases.aiIceCream.result3",
  "videoCases.aiIceCream.result4",
];
...
export default function AiIceCreamPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.aiIceCream.category")}
              </span>
              ...
              <div className="max-w-md mx-auto">
                ...
                >
                  ...
                  <div className="absolute top-2 right-2 flex gap-1.5">
                    ...
                    <span className="bg-amber-500/80 backdrop-blur-md text-white text-[9px] font-medium px-1.5 py-0.5 rounded-full border border-amber-500/30">
                      9:16
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.aiIceCream.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.aiIceCream.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.aiIceCream.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.aiIceCream.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.aiIceCream.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/ai-ice-cream/screenshot.webp"
                  alt="Відгук клієнта"
                  width={500}
                  height={600}
            ...
            <div className="featured-case-card overflow-hidden mt-6" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.aiIceCream.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.aiIceCream.reviewAuthor")} />
                  <p className="text-amber-500 font-semibold">{t("videoCases.aiIceCream.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.aiIceCream.teamMember")}
          </p>
        </div>
      </section>
      ...
      <RelatedProjectsSection currentSlug="ai-ice-cream" section="video" />
