...
const resultItems = [
  "videoCases.skool10Features.result1",
  "videoCases.skool10Features.result2",
  "videoCases.skool10Features.result3",
  "videoCases.skool10Features.result4",
];

const screenshots = [
  { src: "/media/cases/skool-10-features/screen-1.jpg", alt: "Ведучий з іконкою Skool" },
  { src: "/media/cases/skool-10-features/screen-2.webp", alt: "B-roll — Lamborghini" },
  { src: "/media/cases/skool-10-features/screen-3.jpg", alt: "Візуалізація автоматизації" },
  { src: "/media/cases/skool-10-features/screen-4.jpg", alt: "Тайтл — 10 фішок" },
  { src: "/media/cases/skool-10-features/screen-5.webp", alt: "Переваги Claude AI" },
  { src: "/media/cases/skool-10-features/screen-6.jpg", alt: "Демо Claude AI — аналіз ринку" },
  { src: "/media/cases/skool-10-features/screen-7.jpg", alt: "Організація файлів" },
];
...
export default function Skool10FeaturesPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.skool10Features.category")}
              </span>
            ...
            >
              <div className="max-w-3xl mx-auto">
                <div className="relative rounded-xl overflow-hidden bg-background aspect-video cursor-pointer group/thumb">
                  <Image
                    src="/media/cases/skool-10-features/screen-4.jpg"
                    alt="10 фішок Claude AI"
                    width={1280}
                    height={720}
                  ...
                  <a
                    href="https://t.me/FreelanceUADigitalAgency/161/1025"
                    target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.skool10Features.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.skool10Features.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.skool10Features.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.skool10Features.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.skool10Features.reviewTitle")}
            </h2>
          </FadeIn>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.skool10Features.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.skool10Features.reviewAuthor")} />
                  <p className="text-[#FB923C] font-semibold">{t("videoCases.skool10Features.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.skool10Features.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#FB923C] hover:border-[#FB923C]/50 hover:bg-[#FB923C]/10 hover:text-[#FDBA74] font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(251,146,60,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="skool-10-features" section="video" />
    </article>
  );
}
