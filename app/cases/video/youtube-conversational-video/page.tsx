...
const resultItems = [
  "videoCases.youtubeConversationalVideo.result1",
  "videoCases.youtubeConversationalVideo.result2",
  "videoCases.youtubeConversationalVideo.result3",
  "videoCases.youtubeConversationalVideo.result4",
];

const screenshots = [
  { src: "/media/cases/youtube-conversational-video/screenshot-1.jpg", alt: "Розмовне відео — загальний кадр" },
  { src: "/media/cases/youtube-conversational-video/screenshot-2.jpg", alt: "Розмовне відео — крупний план" },
  { src: "/media/cases/youtube-conversational-video/screenshot-3.jpg", alt: "Розмовне відео — ракурс збоку" },
];
...
export default function YoutubeConversationalVideoPage() {
  ...
  return (
    <article className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.youtubeConversationalVideo.category")}
              </span>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.youtubeConversationalVideo.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.youtubeConversationalVideo.subtitle")}
            </p>
          </FadeIn>
          ...
          <div
            ...
            style={
              {
                borderRadius: "16px",
                "--case-glow": "rgba(180, 120, 60, 0.12)",
                "--case-glow-strong": "rgba(180, 120, 60, 0.25)",
            ...
            >
              <div className="max-w-3xl mx-auto">
                <div className="relative rounded-xl overflow-hidden bg-background aspect-video cursor-pointer group/thumb">
                  <Image
                    src="/media/cases/youtube-conversational-video/screenshot-1.jpg"
                    alt="Монтаж розмовного відео"
                    width={1280}
                    height={720}
                    unoptimized
                  ...
                  <div className="absolute top-3 right-3 flex gap-1.5">
                    ...
                    <span className="bg-amber-500/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-amber-500/30">
                      16:9
                    </span>
                  </div>
                  ...
                  >
                    <div className="bg-amber-500/90 backdrop-blur-md rounded-lg px-3 py-2 text-center border border-amber-500/30 hover:bg-amber-500 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.youtubeConversationalVideo.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.youtubeConversationalVideo.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.youtubeConversationalVideo.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.youtubeConversationalVideo.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(180, 120, 60, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.youtubeConversationalVideo.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                <Quote size={28} className="text-amber-500 mx-auto mb-4 opacity-50" />
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.youtubeConversationalVideo.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.youtubeConversationalVideo.reviewAuthor")} />
                  <p className="text-amber-500 font-semibold">{t("videoCases.youtubeConversationalVideo.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.youtubeConversationalVideo.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="magnetic-button inline-flex items-center gap-2 border border-border text-amber-500 hover:border-amber-500/50 hover:bg-amber-500/10 hover:text-amber-400 font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(180,120,60,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="youtube-conversational-video" section="video" />
    </article>
  );
}
