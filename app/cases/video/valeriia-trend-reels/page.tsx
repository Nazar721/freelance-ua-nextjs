...
const resultItems = [
  "videoCases.valeriiaTrendReels.result1",
  "videoCases.valeriiaTrendReels.result2",
  "videoCases.valeriiaTrendReels.result3",
  "videoCases.valeriiaTrendReels.result4",
];
...
export default function ValeriiaTrendReelsPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.valeriiaTrendReels.category")}
              </span>
              ...
              <div className="max-w-md mx-auto">
                ...
                >
                  ...
                  <div className="absolute top-2 right-2 flex gap-1.5">
                    ...
                    <span className="bg-pink-500/80 backdrop-blur-md text-white text-[9px] font-medium px-1.5 py-0.5 rounded-full border border-pink-500/30">
                      9:16
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.valeriiaTrendReels.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.valeriiaTrendReels.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.valeriiaTrendReels.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.valeriiaTrendReels.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.valeriiaTrendReels.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background">
                <Image
                  src="/media/cases/valeriia-trend-reels/screenshot.webp"
                  alt="Відгук клієнта Valeriia"
                  width={500}
                  height={600}
            ...
            <div className="featured-case-card overflow-hidden mt-6" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                ...
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.valeriiaTrendReels.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.valeriiaTrendReels.reviewAuthor")} />
                  <p className="text-pink-500 font-semibold">{t("videoCases.valeriiaTrendReels.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.valeriiaTrendReels.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-pink-500 hover:border-pink-500/50 hover:bg-pink-500/10 hover:text-pink-400 font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(244,114,182,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="valeriia-trend-reels" section="video" />
