...
const resultItems = [
  "videoCases.loganAiPromo.result1",
  "videoCases.loganAiPromo.result2",
  "videoCases.loganAiPromo.result3",
  "videoCases.loganAiPromo.result4",
];
...
export default function LoganAiPromoPage() {
  ...
  return (
    <article className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.loganAiPromo.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#DBA69C] bg-[#DBA69C]/10 px-3 py-1 rounded-full border border-[#DBA69C]/20">
                <Sparkles size={12} />
                AI Generated
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.loganAiPromo.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.loganAiPromo.subtitle")}
            </p>
          </FadeIn>
          ...
          <div
            ...
            style={
              {
                borderRadius: "16px",
                "--case-glow": "rgba(219, 166, 156, 0.12)",
                "--case-glow-strong": "rgba(219, 166, 156, 0.25)",
          ...
          >
            ...
            >
              <div className="flex justify-center">
                <div
                  className="relative rounded-xl overflow-hidden bg-background max-h-[560px] mx-auto cursor-pointer group/thumb"
                ...
                >
                  ...
                  <div className="absolute top-3 right-3 flex gap-1.5">
                    ...
                    <span className="bg-[#DBA69C]/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-[#DBA69C]/30">
                      9:16
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.loganAiPromo.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.loganAiPromo.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.loganAiPromo.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.loganAiPromo.solution")}
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 relative">
        <CurvedDashedLines glowColor="rgba(219, 166, 156, 0.15)" side="both" />
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.loganAiPromo.clientName")}
                </h2>
                <div className="mt-6 text-center">
                  <p className="text-[#DBA69C] font-semibold mb-2 flex items-center gap-2 justify-center">
                    <Sparkles size={16} />
                    {t("videoCases.loganAiPromo.clientRole")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.loganAiPromo.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.loganAiPromo.reviewTitle")}
            </h2>
          </FadeIn>
          ...
          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-10 text-center">
                <Quote size={28} className="text-[#DBA69C] mx-auto mb-4 opacity-50" />
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.loganAiPromo.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.loganAiPromo.reviewAuthor")} />
                  <p className="text-[#DBA69C] font-semibold">{t("videoCases.loganAiPromo.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-muted-foreground">
            {t("videoCases.loganAiPromo.teamMember")}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn y={30} blur={8}>
            ...
            <a
              ...
              className="magnetic-button inline-flex items-center gap-2 border border-border text-[#DBA69C] hover:border-[#DBA69C]/50 hover:bg-[#DBA69C]/10 hover:text-[#E8C4BC] font-semibold px-8 py-4 rounded-full transition-all duration-500 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(219,166,156,0.12)]"
            >
      ...
      <RelatedProjectsSection currentSlug="logan-ai-promo" section="video" />
