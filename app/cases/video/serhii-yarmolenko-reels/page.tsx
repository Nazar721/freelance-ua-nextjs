...
const resultItems = [
  "videoCases.serhiiYarmolenkoReels.result1",
  "videoCases.serhiiYarmolenkoReels.result2",
  "videoCases.serhiiYarmolenkoReels.result3",
  "videoCases.serhiiYarmolenkoReels.result4",
];

const caseVideos = [
  { src: "/media/cases/serhii-yarmolenko-reels/video-1.mp4", duration: "~56с" },
  { src: "/media/cases/serhii-yarmolenko-reels/video-2.mp4", duration: "~1:20" },
  { src: "/media/cases/serhii-yarmolenko-reels/video-3.mp4", duration: "~60с" },
];
...
export default function SerhiiYarmolenkoReelsPage() {
    ...
    <article className="min-h-screen">
          ...
          <FadeIn y={30} blur={8}>
            <div className="flex items-center gap-3 mb-4">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-muted-foreground">
                {t("videoCases.serhiiYarmolenkoReels.category")}
              </span>
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#E1306C] bg-[#E1306C]/10 px-3 py-1 rounded-full border border-[#E1306C]/20">
                <InstagramIcon size={12} />
                Instagram Reels
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 leading-tight">
              {t("videoCases.serhiiYarmolenkoReels.title")}
            </h1>
            <p className="text-muted-foreground text-base md:text-lg max-w-2xl leading-relaxed mb-10">
              {t("videoCases.serhiiYarmolenkoReels.subtitle")}
            </p>
          </FadeIn>

          {/* Video Mockup Grid — 3 videos side by side */}
          <div
                ...
                {caseVideos.map((video, i) => (
                  ...
                  >
                    ...
                    <div className="absolute top-3 right-3 flex gap-1.5">
                      ...
                      <span className="bg-primary/80 backdrop-blur-md text-white text-[10px] font-medium px-2 py-0.5 rounded-full border border-[#6366F1]/30">
                        9:16
                      </span>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.serhiiYarmolenkoReels.challengeTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.serhiiYarmolenkoReels.challenge")}
              </p>
            </motion.div>
            ...
            >
              <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-4">
                ...
                {t("videoCases.serhiiYarmolenkoReels.solutionTitle")}
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                {t("videoCases.serhiiYarmolenkoReels.solution")}
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-foreground mb-6 text-center">
                  {t("videoCases.serhiiYarmolenkoReels.clientName")}
                </h2>
                <div className="relative overflow-hidden rounded-xl border border-border bg-background max-w-lg mx-auto">
                  <Image
                    src="/media/cases/serhii-yarmolenko-reels/profile.webp"
                    alt="Профіль Сергія Ярмоленка — Instagram"
                    width={1342}
                    height={442}
                ...
                <div className="mt-6 text-center">
                  <p className="text-[#E1306C] font-semibold mb-2 flex items-center gap-2 justify-center">
                    <InstagramIcon size={16} />
                    {t("videoCases.serhiiYarmolenkoReels.clientRole")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto">
                    {t("videoCases.serhiiYarmolenkoReels.clientDesc")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <FadeIn y={30} blur={8}>
            <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
              {t("videoCases.serhiiYarmolenkoReels.reviewTitle")}
            </h2>
          </FadeIn>

          <FadeIn delay={0.1} y={30} blur={6}>
            <div className="featured-case-card overflow-hidden" style={{ borderRadius: "20px" }}>
              <div className="relative overflow-hidden flex justify-center bg-background p-6 md:p-8">
                <Image
                  src="/media/cases/serhii-yarmolenko-reels/review.webp"
                  alt="Відгук Сергія Ярмоленка"
                  width={977}
                  height={292}
              ...
              <div className="p-8 md:p-10 text-center">
                <Quote size={28} className="text-primary mx-auto mb-4 opacity-50" />
                <p className="text-foreground text-lg md:text-xl italic leading-relaxed mb-6">
                  &ldquo;{t("videoCases.serhiiYarmolenkoReels.reviewText")}&rdquo;
                </p>
                <div className="flex items-center justify-center gap-3 pt-4 border-t border-border">
                  <ReviewAvatar name={t("videoCases.serhiiYarmolenkoReels.reviewAuthor")} />
                  <p className="text-primary font-semibold">{t("videoCases.serhiiYarmolenkoReels.reviewAuthor")}</p>
                </div>
              </div>
            </div>
          </FadeIn>
      ...
      <RelatedProjectsSection currentSlug="serhii-yarmolenko-reels" section="video" />
