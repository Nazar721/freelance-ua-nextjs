...
export const cases: Case[] = [
  {
    ...
    description: "Виконали замовлення на оформлення банеру для YouTube від діджейки DJANOVA. Клієнт у захваті.",
    review: "Дякую велике за розробку мого банера, ваша команда відтворила саме те що я хотіла...",
  ...
  },
  {
    ...
    review: "Мені дуже подобається. Дякую Freelance UA || Digital Agency, як завжди все чітко...",
  ...
  },
  {
    ...
    description: "Виконали замовлення від блогера Нікіта Шеремет (крипта). Домовились про подальшу співпрацю.",
    review: "Результатом дуже задоволений, якість, швидкість та результат на найвищому рівні...",
